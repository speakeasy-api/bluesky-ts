...
```typescript
import { ComAtprotoRepoPutRecordResponse } from "@speakeasy-sdks/bluesky/models/operations";

let value: ComAtprotoRepoPutRecordResponse = {
  uri: "https://stained-coal.name/",
  cid: "<id>",
};
```
