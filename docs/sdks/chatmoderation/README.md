...
<!-- UsageSnippet language="typescript" operationID="chat.bsky.moderation.getActorMetadata" method="get" path="/xrpc/chat.bsky.moderation.getActorMetadata" -->
```typescript
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("chatModerationGetActorMetadata failed:", res.error);
  }
}
...
**Promise\<[operations.ChatBskyModerationGetActorMetadataResponse](../../models/operations/chatbskymoderationgetactormetadataresponse.md)\>**

### Errors

| Error Type                                                | Status Code                                               | Content Type                                              |
| --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- |
| errors.ChatBskyModerationGetActorMetadataBadRequestError  | 400                                                       | application/json                                          |
| errors.ChatBskyModerationGetActorMetadataAuthMissingError | 401                                                       | application/json                                          |
...
<!-- UsageSnippet language="typescript" operationID="chat.bsky.moderation.updateActorAccess" method="post" path="/xrpc/chat.bsky.moderation.updateActorAccess" -->
```typescript
import { Bluesky } from "@speakeasy-sdks/bluesky";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("chatModerationUpdateActorAccess failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.ChatBskyModerationUpdateActorAccessRequest](../../models/operations/chatbskymoderationupdateactoraccessrequest.md)                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
| Error Type                                                 | Status Code                                                | Content Type                                               |
| ---------------------------------------------------------- | ---------------------------------------------------------- | ---------------------------------------------------------- |
| errors.ChatBskyModerationUpdateActorAccessBadRequestError  | 400                                                        | application/json                                           |
| errors.ChatBskyModerationUpdateActorAccessAuthMissingError | 401                                                        | application/json                                           |
| errors.NotFoundError                                       | 404                                                        | application/json                                           |
| errors.UnauthorizedError                                   | 403, 407                                                   | application/json                                           |
| errors.TimeoutError                                        | 408                                                        | application/json                                           |
| errors.RateLimitedError                                    | 429                                                        | application/json                                           |
