...
<!-- UsageSnippet language="typescript" operationID="tools.ozone.team.listMembers" method="get" path="/xrpc/tools.ozone.team.listMembers" -->
```typescript
...
import { teamListMembers } from "@speakeasy-sdks/bluesky/funcs/teamListMembers.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("teamListMembers failed:", res.error);
  }
}
...
} from "@speakeasy-sdks/bluesky/react-query/teamListMembers.js";
```
...
| ------------------------------------------------ | ------------------------------------------------ | ------------------------------------------------ |
| errors.ToolsOzoneTeamListMembersBadRequestError  | 400                                              | application/json                                 |
| errors.ToolsOzoneTeamListMembersAuthMissingError | 401                                              | application/json                                 |
