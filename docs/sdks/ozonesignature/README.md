...
| --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| errors.BadRequestToolsOzoneSignatureSearchAccountsResponseBodyError   | 400                                                                   | application/json                                                      |
| errors.UnauthorizedToolsOzoneSignatureSearchAccountsResponseBodyError | 401                                                                   | application/json                                                      |
