 ...
 */
export async function atprotoSyncListRepos(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.ComAtprotoSyncListReposAtprotoSyncResponseBody
      | errors.Unauthorized
      | errors.NotFound
      | errors.Timeout
      | errors.BadRequest
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoSyncListReposAtprotoSyncResponseBody$inboundSchema,
    ),
