 ...
 */
export function adminsGetAccountInfos(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoAdminGetAccountInfosBadRequestError
    | errors.ComAtprotoAdminGetAccountInfosAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoAdminGetAccountInfosResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoAdminGetAccountInfosBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminGetAccountInfosAuthMissingError$inboundSchema,
    ),
