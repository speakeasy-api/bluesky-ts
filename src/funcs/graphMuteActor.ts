...
export function graphMuteActor(
  ...
  Result<
    void,
    | errors.AppBskyGraphMuteActorBadRequestError
    | errors.AppBskyGraphMuteActorAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphMuteActorRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(200, z.void()),
    M.jsonErr(400, errors.AppBskyGraphMuteActorBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyGraphMuteActorAuthMissingError$inboundSchema),
