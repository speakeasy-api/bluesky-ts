...
export function adminGetSubjectStatus(
  ...
  Result<
    ...
    | errors.ComAtprotoAdminGetSubjectStatusBadRequestError
    | errors.ComAtprotoAdminGetSubjectStatusAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoAdminGetSubjectStatusResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoAdminGetSubjectStatusBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminGetSubjectStatusAuthMissingError$inboundSchema,
    ),
