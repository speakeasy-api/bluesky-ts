 ...
 */
export async function chatBskyActorChatBskyActorDeleteAccount(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ChatBskyActorDeleteAccountChatBskyActorResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ChatBskyActorDeleteAccountChatBskyActorResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
