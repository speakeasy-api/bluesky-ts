...
export function serverRequestEmailUpdate(
  ...
  Result<
    ...
    | errors.ComAtprotoServerRequestEmailUpdateBadRequestError
    | errors.ComAtprotoServerRequestEmailUpdateAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoServerRequestEmailUpdateResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoServerRequestEmailUpdateBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerRequestEmailUpdateAuthMissingError$inboundSchema,
    ),
