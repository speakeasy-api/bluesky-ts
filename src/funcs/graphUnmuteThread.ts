 ...
 */
export function graphUnmuteThread(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.AppBskyGraphUnmuteThreadBadRequestError
    | errors.AppBskyGraphUnmuteThreadAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphUnmuteThreadRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/app.bsky.graph.unmuteThread")();
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyGraphUnmuteThreadBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphUnmuteThreadAuthMissingError$inboundSchema,
    ),
