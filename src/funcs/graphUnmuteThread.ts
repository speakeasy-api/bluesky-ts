...
export function graphUnmuteThread(
  ...
  Result<
    void,
    | errors.BadRequestAppBskyGraphUnmuteThreadResponseBodyError
    | errors.UnauthorizedAppBskyGraphUnmuteThreadResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphUnmuteThreadBody$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestAppBskyGraphUnmuteThreadResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
