...
export function actorsGetPreferences(
  ...
  Result<
    operations.AppBskyActorGetPreferencesResponse,
    | errors.AppBskyActorGetPreferencesBadRequestError
    | errors.AppBskyActorGetPreferencesAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppBskyActorGetPreferencesResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.AppBskyActorGetPreferencesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyActorGetPreferencesAuthMissingError$inboundSchema,
    ),
