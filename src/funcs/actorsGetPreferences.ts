 ...
 */
export async function actorsGetPreferences(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.AppBskyActorGetPreferencesActorsResponseBody
    | errors.NotFound
    | errors.Unauthorized
    | errors.Timeout
    | errors.RateLimited
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.AppBskyActorGetPreferencesActorsResponseBody$inboundSchema,
    ),
