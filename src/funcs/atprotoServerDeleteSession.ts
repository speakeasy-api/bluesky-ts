...
export function atprotoServerDeleteSession(
  ...
  Result<
    void,
    | errors.ComAtprotoServerDeleteSessionBadRequestError
    | errors.ComAtprotoServerDeleteSessionAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoServerDeleteSessionBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerDeleteSessionAuthMissingError$inboundSchema,
    ),
