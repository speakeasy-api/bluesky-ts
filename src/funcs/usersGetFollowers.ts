...
export function usersGetFollowers(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetFollowersBadRequestError
      | errors.AppBskyGraphGetFollowersAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyGraphGetFollowersBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphGetFollowersAuthMissingError$inboundSchema,
    ),
