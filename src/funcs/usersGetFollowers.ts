...
export function usersGetFollowers(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyGraphGetFollowersResponseBodyError
      | errors.UnauthorizedAppBskyGraphGetFollowersResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestAppBskyGraphGetFollowersResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
