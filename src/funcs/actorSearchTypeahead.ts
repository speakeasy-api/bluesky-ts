 ...
 */
export function actorSearchTypeahead(
  client: BlueskyCore,
  request?: operations.AppBskyActorSearchActorsTypeaheadRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppBskyActorSearchActorsTypeaheadResponse,
    | errors.AppBskyActorSearchActorsTypeaheadBadRequestError
    | errors.AppBskyActorSearchActorsTypeaheadAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyActorSearchActorsTypeaheadRequest$outboundSchema
  ...
  const path = pathToFunc("/xrpc/app.bsky.actor.searchActorsTypeahead")();
  ...
  >(
    M.json(
      200,
      operations.AppBskyActorSearchActorsTypeaheadResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.AppBskyActorSearchActorsTypeaheadBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyActorSearchActorsTypeaheadAuthMissingError$inboundSchema,
    ),
