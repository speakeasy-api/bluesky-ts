...
export function setsGetValues(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestToolsOzoneSetGetValuesResponseBodyError
      | errors.UnauthorizedToolsOzoneSetGetValuesResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneSetGetValuesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/tools.ozone.set.getValues")();
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ToolsOzoneSetGetValuesResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
      400,
      errors.BadRequestToolsOzoneSetGetValuesResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedToolsOzoneSetGetValuesResponseBodyError$inboundSchema,
    ),
