...
export function setsGetValues(
  ...
  PageIterator<
    Result<
      ...
      | errors.ToolsOzoneSetGetValuesBadRequestError
      | errors.ToolsOzoneSetGetValuesAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.ToolsOzoneSetGetValuesBadRequestError$inboundSchema),
    M.jsonErr(401, errors.ToolsOzoneSetGetValuesAuthMissingError$inboundSchema),
