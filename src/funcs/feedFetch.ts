...
export function feedFetch(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyFeedGetFeedResponseBodyError
      | errors.UnauthorizedAppBskyFeedGetFeedResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestAppBskyFeedGetFeedResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedAppBskyFeedGetFeedResponseBodyError$inboundSchema,
    ),
