...
export function feedFetch(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetFeedBadRequestError
      | errors.AppBskyFeedGetFeedAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.AppBskyFeedGetFeedBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyFeedGetFeedAuthMissingError$inboundSchema),
