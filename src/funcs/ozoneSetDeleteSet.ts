 ...
 */
export async function ozoneSetDeleteSet(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ToolsOzoneSetDeleteSetOzoneSetResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ToolsOzoneSetDeleteSetOzoneSetResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
