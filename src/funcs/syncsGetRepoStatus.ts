...
export function syncsGetRepoStatus(
  ...
  Result<
    ...
    | errors.ComAtprotoSyncGetRepoStatusBadRequestError
    | errors.ComAtprotoSyncGetRepoStatusAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComAtprotoSyncGetRepoStatusResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ComAtprotoSyncGetRepoStatusBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoSyncGetRepoStatusAuthMissingError$inboundSchema,
    ),
