...
export function labelersGetServices(
  ...
  Result<
    ...
    | errors.AppBskyLabelerGetServicesBadRequestError
    | errors.AppBskyLabelerGetServicesAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppBskyLabelerGetServicesResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.AppBskyLabelerGetServicesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyLabelerGetServicesAuthMissingError$inboundSchema,
    ),
