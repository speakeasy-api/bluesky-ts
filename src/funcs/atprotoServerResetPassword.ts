...
export function atprotoServerResetPassword(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoServerResetPasswordResponseBodyError
    | errors.UnauthorizedComAtprotoServerResetPasswordResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerResetPasswordBody$outboundSchema.parse(value),
