 ...
 */
export function atprotoServerResetPassword(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.ComAtprotoServerResetPasswordBadRequestError
    | errors.ComAtprotoServerResetPasswordAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerResetPasswordRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoServerResetPasswordBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerResetPasswordAuthMissingError$inboundSchema,
    ),
