...
export function ozoneSetAdd(
  ...
  Result<
    void,
    | errors.ToolsOzoneSetAddValuesBadRequestError
    | errors.ToolsOzoneSetAddValuesAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneSetAddValuesRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(200, z.void()),
    M.jsonErr(400, errors.ToolsOzoneSetAddValuesBadRequestError$inboundSchema),
    M.jsonErr(401, errors.ToolsOzoneSetAddValuesAuthMissingError$inboundSchema),
