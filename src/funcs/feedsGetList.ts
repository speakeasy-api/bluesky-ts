...
export function feedsGetList(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyFeedGetListFeedResponseBodyError
      | errors.UnauthorizedAppBskyFeedGetListFeedResponseBodyError
...
> {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyFeedGetListFeedResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
      400,
      errors.BadRequestAppBskyFeedGetListFeedResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedAppBskyFeedGetListFeedResponseBodyError$inboundSchema,
    ),
