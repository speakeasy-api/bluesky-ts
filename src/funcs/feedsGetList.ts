...
export function feedsGetList(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetListFeedBadRequestError
      | errors.AppBskyFeedGetListFeedAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.AppBskyFeedGetListFeedBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyFeedGetListFeedAuthMissingError$inboundSchema),
