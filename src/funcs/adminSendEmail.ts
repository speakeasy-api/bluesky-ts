...
export function adminSendEmail(
  ...
  Result<
    ...
    | errors.ComAtprotoAdminSendEmailBadRequestError
    | errors.ComAtprotoAdminSendEmailAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminSendEmailRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComAtprotoAdminSendEmailResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ComAtprotoAdminSendEmailBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminSendEmailAuthMissingError$inboundSchema,
    ),
