 ...
 */
export async function atprotoRepoImportRepo(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoRepoImportRepoAtprotoRepoResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoRepoImportRepoAtprotoRepoResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
