...
export function atprotoAdminGetInviteCodes(
  ...
  PageIterator<
    Result<
      ...
      | errors.ComAtprotoAdminGetInviteCodesBadRequestError
      | errors.ComAtprotoAdminGetInviteCodesAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoAdminGetInviteCodesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminGetInviteCodesAuthMissingError$inboundSchema,
    ),
