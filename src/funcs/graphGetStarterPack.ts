 ...
 */
export function graphGetStarterPack(
  client: BlueskyCore,
  request: operations.AppBskyGraphGetStarterPackRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppBskyGraphGetStarterPackResponse,
    | errors.AppBskyGraphGetStarterPackBadRequestError
    | errors.AppBskyGraphGetStarterPackAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphGetStarterPackRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/app.bsky.graph.getStarterPack")();

  const query = encodeFormQuery({
    "starterPack": payload.starterPack,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppBskyGraphGetStarterPackResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.AppBskyGraphGetStarterPackBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphGetStarterPackAuthMissingError$inboundSchema,
    ),
