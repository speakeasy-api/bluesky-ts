 ...
 */
export async function toolsOzoneSetToolsOzoneSetUpsertSet(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ToolsOzoneSetUpsertSetToolsOzoneSetResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ToolsOzoneSetUpsertSetToolsOzoneSetResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
