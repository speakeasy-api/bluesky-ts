...
export function ozoneModerationGet(
  ...
  Result<
    ...
    | errors.ToolsOzoneModerationGetRepoBadRequestError
    | errors.ToolsOzoneModerationGetRepoAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneModerationGetRepoBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneModerationGetRepoAuthMissingError$inboundSchema,
    ),
