 ...
 */
export function atprotoServerCreateInviteCode(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoServerCreateInviteCodeBadRequestError
    | errors.ComAtprotoServerCreateInviteCodeAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerCreateInviteCodeRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoServerCreateInviteCodeResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoServerCreateInviteCodeBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerCreateInviteCodeAuthMissingError$inboundSchema,
    ),
