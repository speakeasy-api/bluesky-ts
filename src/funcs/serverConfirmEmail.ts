...
export function serverConfirmEmail(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoServerConfirmEmailResponseBodyError
    | errors.UnauthorizedComAtprotoServerConfirmEmailResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerConfirmEmailBody$outboundSchema.parse(value),
