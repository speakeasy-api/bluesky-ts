...
export function serverConfirmEmail(
  ...
  Result<
    void,
    | errors.ComAtprotoServerConfirmEmailBadRequestError
    | errors.ComAtprotoServerConfirmEmailAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerConfirmEmailRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoServerConfirmEmailBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerConfirmEmailAuthMissingError$inboundSchema,
    ),
