 ...
 */
export function ozoneCommunicationListTemplates(
  client: BlueskyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ToolsOzoneCommunicationListTemplatesResponse,
    | errors.ToolsOzoneCommunicationListTemplatesBadRequestError
    | errors.ToolsOzoneCommunicationListTemplatesAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ToolsOzoneCommunicationListTemplatesResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ToolsOzoneCommunicationListTemplatesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneCommunicationListTemplatesAuthMissingError$inboundSchema,
    ),
