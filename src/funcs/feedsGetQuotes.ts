 ...
 */
export function feedsGetQuotes(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyFeedGetQuotesResponseBodyError
      | errors.UnauthorizedAppBskyFeedGetQuotesResponseBodyError
...
> {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyFeedGetQuotesResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
      400,
      errors.BadRequestAppBskyFeedGetQuotesResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedAppBskyFeedGetQuotesResponseBodyError$inboundSchema,
    ),
