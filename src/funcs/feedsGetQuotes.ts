 ...
 */
export async function feedsGetQuotes(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetQuotesFeedsResponseBody
      | errors.NotFound
      | errors.Unauthorized
      | errors.Timeout
      | errors.RateLimited
...
> {
  ...
  >(
    ...
    M.jsonErr(401, errors.AppBskyFeedGetQuotesFeedsResponseBody$inboundSchema),
