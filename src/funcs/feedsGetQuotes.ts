...
export function feedsGetQuotes(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetQuotesBadRequestError
      | errors.AppBskyFeedGetQuotesAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.AppBskyFeedGetQuotesBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyFeedGetQuotesAuthMissingError$inboundSchema),
