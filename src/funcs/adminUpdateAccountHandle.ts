 ...
 */
export function adminUpdateAccountHandle(
  client: BlueskyCore,
  request: operations.ComAtprotoAdminUpdateAccountHandleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    void,
    | errors.ComAtprotoAdminUpdateAccountHandleBadRequestError
    | errors.ComAtprotoAdminUpdateAccountHandleAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminUpdateAccountHandleRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/xrpc/com.atproto.admin.updateAccountHandle")();
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoAdminUpdateAccountHandleBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminUpdateAccountHandleAuthMissingError$inboundSchema,
    ),
