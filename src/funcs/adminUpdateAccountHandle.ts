 ...
 */
export async function adminUpdateAccountHandle(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoAdminUpdateAccountHandleAdminResponseBody
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
    | errors.BadRequest
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoAdminUpdateAccountHandleAdminResponseBody$inboundSchema,
    ),
