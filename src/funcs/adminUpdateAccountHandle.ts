...
export function adminUpdateAccountHandle(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoAdminUpdateAccountHandleResponseBodyError
    | errors.UnauthorizedComAtprotoAdminUpdateAccountHandleResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminUpdateAccountHandleBody$outboundSchema.parse(
        value,
      ),
