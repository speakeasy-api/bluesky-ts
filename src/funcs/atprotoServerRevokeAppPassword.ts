...
export function atprotoServerRevokeAppPassword(
  ...
  Result<
    void,
    | errors.ComAtprotoServerRevokeAppPasswordBadRequestError
    | errors.ComAtprotoServerRevokeAppPasswordAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerRevokeAppPasswordRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoServerRevokeAppPasswordBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerRevokeAppPasswordAuthMissingError$inboundSchema,
    ),
