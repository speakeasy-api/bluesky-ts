...
export function atprotoServerRevokeAppPassword(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoServerRevokeAppPasswordResponseBodyError
    | errors.UnauthorizedComAtprotoServerRevokeAppPasswordResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerRevokeAppPasswordBody$outboundSchema.parse(
        value,
      ),
