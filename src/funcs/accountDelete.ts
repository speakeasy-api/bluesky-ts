...
export function accountDelete(
  ...
  Result<
    ...
    | errors.ChatBskyActorDeleteAccountBadRequestError
    | errors.ChatBskyActorDeleteAccountAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ChatBskyActorDeleteAccountResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ChatBskyActorDeleteAccountBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ChatBskyActorDeleteAccountAuthMissingError$inboundSchema,
    ),
