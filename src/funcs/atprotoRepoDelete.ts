 ...
 */
export function atprotoRepoDelete(
  client: BlueskyCore,
  request: operations.ComAtprotoRepoDeleteRecordRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComAtprotoRepoDeleteRecordResponse,
    | errors.ComAtprotoRepoDeleteRecordBadRequestError
    | errors.ComAtprotoRepoDeleteRecordAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoRepoDeleteRecordRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComAtprotoRepoDeleteRecordResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ComAtprotoRepoDeleteRecordBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoRepoDeleteRecordAuthMissingError$inboundSchema,
    ),
