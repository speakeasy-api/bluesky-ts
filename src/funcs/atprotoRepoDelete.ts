...
export function atprotoRepoDelete(
  ...
  Result<
    ...
    | errors.BadRequestComAtprotoRepoDeleteRecordResponseBodyError
    | errors.UnauthorizedComAtprotoRepoDeleteRecordResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoRepoDeleteRecordBody$outboundSchema.parse(value),
