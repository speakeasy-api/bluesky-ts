 ...
 */
export function usersGetSuggestedFollows(
  client: BlueskyCore,
  request: operations.AppBskyGraphGetSuggestedFollowsByActorRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppBskyGraphGetSuggestedFollowsByActorResponse,
    | errors.AppBskyGraphGetSuggestedFollowsByActorBadRequestError
    | errors.AppBskyGraphGetSuggestedFollowsByActorAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphGetSuggestedFollowsByActorRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/xrpc/app.bsky.graph.getSuggestedFollowsByActor")();
  ...
  >(
    M.json(
      200,
      operations.AppBskyGraphGetSuggestedFollowsByActorResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors
