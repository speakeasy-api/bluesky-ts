 ...
 */
export function graphsUnmuteActorList(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.AppBskyGraphUnmuteActorListBadRequestError
    | errors.AppBskyGraphUnmuteActorListAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphUnmuteActorListRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyGraphUnmuteActorListBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphUnmuteActorListAuthMissingError$inboundSchema,
    ),
