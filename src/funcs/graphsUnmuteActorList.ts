...
export function graphsUnmuteActorList(
  ...
  Result<
    void,
    | errors.BadRequestAppBskyGraphUnmuteActorListResponseBodyError
    | errors.UnauthorizedAppBskyGraphUnmuteActorListResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphUnmuteActorListBody$outboundSchema.parse(value),
