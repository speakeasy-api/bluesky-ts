 ...
 */
export function signatureFindCorrelation(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ToolsOzoneSignatureFindCorrelationBadRequestError
    | errors.ToolsOzoneSignatureFindCorrelationAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ToolsOzoneSignatureFindCorrelationResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ToolsOzoneSignatureFindCorrelationBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneSignatureFindCorrelationAuthMissingError$inboundSchema,
    ),
