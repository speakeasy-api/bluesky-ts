...
export function syncGetRepo(
  ...
  Result<
    void,
    | errors.ComAtprotoSyncGetRepoBadRequestError
    | errors.ComAtprotoSyncGetRepoAuthMissingError
...
> {
  ...
  >(
    M.nil(200, z.void()),
    M.jsonErr(400, errors.ComAtprotoSyncGetRepoBadRequestError$inboundSchema),
    M.jsonErr(401, errors.ComAtprotoSyncGetRepoAuthMissingError$inboundSchema),
