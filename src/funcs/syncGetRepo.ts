...
export function syncGetRepo(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoSyncGetRepoResponseBodyError
    | errors.UnauthorizedComAtprotoSyncGetRepoResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestComAtprotoSyncGetRepoResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedComAtprotoSyncGetRepoResponseBodyError$inboundSchema,
    ),
