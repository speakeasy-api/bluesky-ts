...
export function feedGetSkeleton(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetFeedSkeletonBadRequestError
      | errors.AppBskyFeedGetFeedSkeletonAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyFeedGetFeedSkeletonBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyFeedGetFeedSkeletonAuthMissingError$inboundSchema,
    ),
