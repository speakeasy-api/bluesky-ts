 ...
 */
export function feedGetSkeleton(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyFeedGetFeedSkeletonResponseBodyError
      | errors.UnauthorizedAppBskyFeedGetFeedSkeletonResponseBodyError
