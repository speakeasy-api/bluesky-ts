 ...
 */
export function notificationsPutPreferences(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.AppBskyNotificationPutPreferencesBadRequestError
    | errors.AppBskyNotificationPutPreferencesAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyNotificationPutPreferencesRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyNotificationPutPreferencesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyNotificationPutPreferencesAuthMissingError$inboundSchema,
    ),
