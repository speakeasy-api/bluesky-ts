...
export function notificationsPutPreferences(
  ...
  Result<
    void,
    | errors.BadRequestAppBskyNotificationPutPreferencesResponseBodyError
    | errors.UnauthorizedAppBskyNotificationPutPreferencesResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyNotificationPutPreferencesBody$outboundSchema.parse(
        value,
      ),
