 ...
 */
export async function toolsOzoneCommunicationToolsOzoneCommunicationCreateTemplate(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ToolsOzoneCommunicationCreateTemplateToolsOzoneCommunicationResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
