 ...
 */
export function atprotoServerDeleteAccount(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.ComAtprotoServerDeleteAccountBadRequestError
    | errors.ComAtprotoServerDeleteAccountAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerDeleteAccountRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoServerDeleteAccountBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerDeleteAccountAuthMissingError$inboundSchema,
    ),
