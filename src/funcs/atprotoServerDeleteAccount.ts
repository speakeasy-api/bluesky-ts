...
export function atprotoServerDeleteAccount(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoServerDeleteAccountResponseBodyError
    | errors.UnauthorizedComAtprotoServerDeleteAccountResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerDeleteAccountBody$outboundSchema.parse(value),
