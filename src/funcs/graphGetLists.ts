...
export function graphGetLists(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetListsBadRequestError
      | errors.AppBskyGraphGetListsAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.AppBskyGraphGetListsBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyGraphGetListsAuthMissingError$inboundSchema),
