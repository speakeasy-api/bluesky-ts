...
export async function comAtprotoAdminComAtprotoAdminSearchAccounts(
  ...
  Result<
    operations.ComAtprotoAdminSearchAccountsResponseBody,
    | errors.ComAtprotoAdminSearchAccountsResponseBody
    | errors.ComAtprotoAdminSearchAccountsComAtprotoAdminResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoAdminSearchAccountsResponseBody$inboundSchema,
    ),
    M.jsonErr(
      400,
