...
export function graphsGetBlocks(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetBlocksBadRequestError
      | errors.AppBskyGraphGetBlocksAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.AppBskyGraphGetBlocksBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyGraphGetBlocksAuthMissingError$inboundSchema),
