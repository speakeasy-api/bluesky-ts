 ...
 */
export function graphsGetBlocks(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyGraphGetBlocksResponseBodyError
      | errors.UnauthorizedAppBskyGraphGetBlocksResponseBodyError
...
> {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyGraphGetBlocksResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
      400,
      errors.BadRequestAppBskyGraphGetBlocksResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedAppBskyGraphGetBlocksResponseBodyError$inboundSchema,
    ),
