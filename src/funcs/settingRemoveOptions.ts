...
export function settingRemoveOptions(
  ...
  Result<
    ...
    | errors.BadRequestToolsOzoneSettingRemoveOptionsResponseBodyError
    | errors.UnauthorizedToolsOzoneSettingRemoveOptionsResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneSettingRemoveOptionsBody$outboundSchema.parse(value),
