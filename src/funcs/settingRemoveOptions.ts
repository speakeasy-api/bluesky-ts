...
export function settingRemoveOptions(
  ...
  Result<
    operations.ToolsOzoneSettingRemoveOptionsResponse,
    | errors.ToolsOzoneSettingRemoveOptionsBadRequestError
    | errors.ToolsOzoneSettingRemoveOptionsAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneSettingRemoveOptionsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ToolsOzoneSettingRemoveOptionsResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ToolsOzoneSettingRemoveOptionsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneSettingRemoveOptionsAuthMissingError$inboundSchema,
    ),
