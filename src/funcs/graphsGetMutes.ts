...
export function graphsGetMutes(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetMutesBadRequestError
      | errors.AppBskyGraphGetMutesAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.AppBskyGraphGetMutesBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyGraphGetMutesAuthMissingError$inboundSchema),
