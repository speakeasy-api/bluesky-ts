...
export function atprotoServerDescribe(
  ...
  Result<
    operations.ComAtprotoServerDescribeServerResponse,
    | errors.ComAtprotoServerDescribeServerBadRequestError
    | errors.ComAtprotoServerDescribeServerAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoServerDescribeServerResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoServerDescribeServerBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerDescribeServerAuthMissingError$inboundSchema,
    ),
