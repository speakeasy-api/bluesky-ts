...
export function chatConvosGetMessages(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestChatBskyConvoGetMessagesResponseBodyError
      | errors.UnauthorizedChatBskyConvoGetMessagesResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestChatBskyConvoGetMessagesResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
