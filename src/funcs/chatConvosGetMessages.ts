...
export function chatConvosGetMessages(
  ...
  PageIterator<
    Result<
      ...
      | errors.ChatBskyConvoGetMessagesBadRequestError
      | errors.ChatBskyConvoGetMessagesAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ChatBskyConvoGetMessagesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ChatBskyConvoGetMessagesAuthMissingError$inboundSchema,
    ),
