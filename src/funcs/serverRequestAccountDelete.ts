 ...
 */
export function serverRequestAccountDelete(
  client: BlueskyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    void,
    | errors.ComAtprotoServerRequestAccountDeleteBadRequestError
    | errors.ComAtprotoServerRequestAccountDeleteAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoServerRequestAccountDeleteBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerRequestAccountDeleteAuthMissingError$inboundSchema,
    ),
