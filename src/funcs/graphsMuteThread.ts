 ...
 */
export function graphsMuteThread(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.BadRequestAppBskyGraphMuteThreadResponseBodyError
    | errors.UnauthorizedAppBskyGraphMuteThreadResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphMuteThreadBody$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestAppBskyGraphMuteThreadResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedAppBskyGraphMuteThreadResponseBodyError$inboundSchema,
    ),
