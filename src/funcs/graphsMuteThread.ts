...
export function graphsMuteThread(
  ...
  Result<
    void,
    | errors.AppBskyGraphMuteThreadBadRequestError
    | errors.AppBskyGraphMuteThreadAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphMuteThreadRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(200, z.void()),
    M.jsonErr(400, errors.AppBskyGraphMuteThreadBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyGraphMuteThreadAuthMissingError$inboundSchema),
