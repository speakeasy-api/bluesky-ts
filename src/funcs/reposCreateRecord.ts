...
export function reposCreateRecord(
  ...
  Result<
    ...
    | errors.ComAtprotoRepoCreateRecordBadRequestError
    | errors.ComAtprotoRepoCreateRecordAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoRepoCreateRecordRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComAtprotoRepoCreateRecordResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ComAtprotoRepoCreateRecordBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoRepoCreateRecordAuthMissingError$inboundSchema,
    ),
