...
export function reposCreateRecord(
  ...
  Result<
    ...
    | errors.BadRequestComAtprotoRepoCreateRecordResponseBodyError
    | errors.UnauthorizedComAtprotoRepoCreateRecordResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoRepoCreateRecordBody$outboundSchema.parse(value),
