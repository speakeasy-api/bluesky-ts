...
export function ozoneSettingsUpsertOption(
  ...
  Result<
    ...
    | errors.BadRequestToolsOzoneSettingUpsertOptionResponseBodyError
    | errors.UnauthorizedToolsOzoneSettingUpsertOptionResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneSettingUpsertOptionBody$outboundSchema.parse(value),
