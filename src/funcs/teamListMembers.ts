...
export function teamListMembers(
  ...
  PageIterator<
    Result<
      ...
      | errors.ToolsOzoneTeamListMembersBadRequestError
      | errors.ToolsOzoneTeamListMembersAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneTeamListMembersBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneTeamListMembersAuthMissingError$inboundSchema,
    ),
