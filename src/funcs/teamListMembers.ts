...
export function teamListMembers(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestToolsOzoneTeamListMembersResponseBodyError
      | errors.UnauthorizedToolsOzoneTeamListMembersResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestToolsOzoneTeamListMembersResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
