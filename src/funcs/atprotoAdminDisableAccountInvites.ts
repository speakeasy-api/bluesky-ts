...
export function atprotoAdminDisableAccountInvites(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoAdminDisableAccountInvitesResponseBodyError
    | errors.UnauthorizedComAtprotoAdminDisableAccountInvitesResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminDisableAccountInvitesBody$outboundSchema.parse(
        value,
      ),
