 ...
 */
export function atprotoAdminDisableAccountInvites(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.ComAtprotoAdminDisableAccountInvitesBadRequestError
    | errors.ComAtprotoAdminDisableAccountInvitesAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminDisableAccountInvitesRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/xrpc/com.atproto.admin.disableAccountInvites")();
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoAdminDisableAccountInvitesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminDisableAccountInvitesAuthMissingError$inboundSchema,
    ),
