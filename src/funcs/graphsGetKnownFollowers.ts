...
export function graphsGetKnownFollowers(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetKnownFollowersBadRequestError
      | errors.AppBskyGraphGetKnownFollowersAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphGetKnownFollowersRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/xrpc/app.bsky.graph.getKnownFollowers")();
  ...
  >(
    M.json(
      200,
      operations.AppBskyGraphGetKnownFollowersResponse$inboundSchema,
      { key: "Result" },
    ),
    M.jsonErr(
      400,
      errors.AppBskyGraphGetKnownFollowersBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphGetKnownFollowersAuthMissingError$inboundSchema,
    ),
