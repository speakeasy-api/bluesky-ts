 ...
 */
export async function comAtprotoLabelComAtprotoLabelQueryLabels(
  client: BlueskyCore,
  request: operations.ComAtprotoLabelQueryLabelsRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.ComAtprotoLabelQueryLabelsResponseBody,
    | errors.ComAtprotoLabelQueryLabelsResponseBody
    | errors.ComAtprotoLabelQueryLabelsComAtprotoLabelResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoLabelQueryLabelsResponseBody$inboundSchema,
    ),
