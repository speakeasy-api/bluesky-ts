...
export function setDelete(
  ...
  Result<
    operations.ToolsOzoneSetDeleteSetResponse,
    | errors.ToolsOzoneSetDeleteSetBadRequestError
    | errors.ToolsOzoneSetDeleteSetAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneSetDeleteSetRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToolsOzoneSetDeleteSetResponse$inboundSchema),
    M.jsonErr(400, errors.ToolsOzoneSetDeleteSetBadRequestError$inboundSchema),
    M.jsonErr(401, errors.ToolsOzoneSetDeleteSetAuthMissingError$inboundSchema),
