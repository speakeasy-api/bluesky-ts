...
export function actorsGetProfiles(
  ...
  Result<
    ...
    | errors.BadRequestAppBskyActorGetProfilesResponseBodyError
    | errors.UnauthorizedAppBskyActorGetProfilesResponseBodyError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyActorGetProfilesResponseBody$inboundSchema),
    M.jsonErr(
      400,
      errors.BadRequestAppBskyActorGetProfilesResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedAppBskyActorGetProfilesResponseBodyError$inboundSchema,
    ),
