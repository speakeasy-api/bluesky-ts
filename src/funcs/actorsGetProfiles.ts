 ...
 */
export function actorsGetProfiles(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.AppBskyActorGetProfilesBadRequestError
    | errors.AppBskyActorGetProfilesAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyActorGetProfilesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/app.bsky.actor.getProfiles")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppBskyActorGetProfilesResponse$inboundSchema),
    M.jsonErr(400, errors.AppBskyActorGetProfilesBadRequestError$inboundSchema),
    M.jsonErr(
      401,
      errors.AppBskyActorGetProfilesAuthMissingError$inboundSchema,
    ),
