 ...
 */
export function adminGetAccountInfo(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoAdminGetAccountInfoBadRequestError
    | errors.ComAtprotoAdminGetAccountInfoAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoAdminGetAccountInfoBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminGetAccountInfoAuthMissingError$inboundSchema,
    ),
