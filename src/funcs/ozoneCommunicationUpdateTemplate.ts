...
export function ozoneCommunicationUpdateTemplate(
  ...
  Result<
    ...
    | errors.ToolsOzoneCommunicationUpdateTemplateBadRequestError
    | errors.ToolsOzoneCommunicationUpdateTemplateAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneCommunicationUpdateTemplateRequest$outboundSchema
        .parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneCommunicationUpdateTemplateBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
