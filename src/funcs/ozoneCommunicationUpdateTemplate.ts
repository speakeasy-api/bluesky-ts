...
export function ozoneCommunicationUpdateTemplate(
  ...
  Result<
    ...
    | errors.BadRequestToolsOzoneCommunicationUpdateTemplateResponseBodyError
    | errors.UnauthorizedToolsOzoneCommunicationUpdateTemplateResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneCommunicationUpdateTemplateBody$outboundSchema.parse(
        value,
      ),
