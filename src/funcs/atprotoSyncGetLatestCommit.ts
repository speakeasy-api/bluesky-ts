 ...
 */
export async function atprotoSyncGetLatestCommit(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoSyncGetLatestCommitAtprotoSyncResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoSyncGetLatestCommitAtprotoSyncResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
