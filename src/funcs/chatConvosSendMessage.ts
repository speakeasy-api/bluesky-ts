 ...
 */
export async function chatConvosSendMessage(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ChatBskyConvoSendMessageChatConvosResponseBody
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
    | errors.BadRequest
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ChatBskyConvoSendMessageChatConvosResponseBody$inboundSchema,
    ),
