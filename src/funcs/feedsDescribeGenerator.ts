 ...
 */
export function feedsDescribeGenerator(
  client: BlueskyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppBskyFeedDescribeFeedGeneratorResponse,
    | errors.AppBskyFeedDescribeFeedGeneratorBadRequestError
    | errors.AppBskyFeedDescribeFeedGeneratorAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.AppBskyFeedDescribeFeedGeneratorResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.AppBskyFeedDescribeFeedGeneratorBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyFeedDescribeFeedGeneratorAuthMissingError$inboundSchema,
    ),
