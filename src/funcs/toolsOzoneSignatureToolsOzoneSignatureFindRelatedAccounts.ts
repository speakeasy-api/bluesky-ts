 ...
 */
export async function toolsOzoneSignatureToolsOzoneSignatureFindRelatedAccounts(
  client: BlueskyCore,
  request: operations.ToolsOzoneSignatureFindRelatedAccountsRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.ToolsOzoneSignatureFindRelatedAccountsResponseBody,
    | errors.ToolsOzoneSignatureFindRelatedAccountsResponseBody
    | errors.ToolsOzoneSignatureFindRelatedAccountsToolsOzoneSignatureResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneSignatureFindRelatedAccountsResponseBody$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
