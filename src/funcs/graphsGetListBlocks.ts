...
export function graphsGetListBlocks(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyGraphGetListBlocksResponseBodyError
      | errors.UnauthorizedAppBskyGraphGetListBlocksResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestAppBskyGraphGetListBlocksResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
