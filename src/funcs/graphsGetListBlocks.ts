...
export function graphsGetListBlocks(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetListBlocksBadRequestError
      | errors.AppBskyGraphGetListBlocksAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyGraphGetListBlocksBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphGetListBlocksAuthMissingError$inboundSchema,
    ),
