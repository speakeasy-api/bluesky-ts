 ...
 */
export async function graphsGetListBlocks(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetListBlocksGraphsResponseBody
      | errors.Unauthorized
      | errors.NotFound
      | errors.Timeout
      | errors.BadRequest
...
> {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyGraphGetListBlocksResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(400, errors.AppBskyGraphGetListBlocksResponseBody$inboundSchema),
    M.jsonErr(
      401,
      errors.AppBskyGraphGetListBlocksGraphsResponseBody$inboundSchema,
    ),
