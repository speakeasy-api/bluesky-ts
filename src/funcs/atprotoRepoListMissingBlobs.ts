 ...
 */
export async function atprotoRepoListMissingBlobs(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.ComAtprotoRepoListMissingBlobsAtprotoRepoResponseBody
      | APIError
      | SDKValidationError
      | UnexpectedClientError
      | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoRepoListMissingBlobsResponseBody$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
