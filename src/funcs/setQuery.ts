...
export function setQuery(
  ...
  PageIterator<
    Result<
      ...
      | errors.ToolsOzoneSetQuerySetsBadRequestError
      | errors.ToolsOzoneSetQuerySetsAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.ToolsOzoneSetQuerySetsBadRequestError$inboundSchema),
    M.jsonErr(401, errors.ToolsOzoneSetQuerySetsAuthMissingError$inboundSchema),
