...
export async function toolsOzoneModerationToolsOzoneModerationQueryEvents(
  ...
  Result<
    operations.ToolsOzoneModerationQueryEventsResponseBody,
    | errors.ToolsOzoneModerationQueryEventsResponseBody
    | errors.ToolsOzoneModerationQueryEventsToolsOzoneModerationResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ToolsOzoneModerationQueryEventsResponseBody$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ToolsOzoneModerationQueryEventsResponseBody$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
