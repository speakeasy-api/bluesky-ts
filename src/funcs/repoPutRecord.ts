...
export function repoPutRecord(
  ...
  Result<
    ...
    | errors.ComAtprotoRepoPutRecordBadRequestError
    | errors.ComAtprotoRepoPutRecordAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoRepoPutRecordRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComAtprotoRepoPutRecordResponse$inboundSchema),
    M.jsonErr(400, errors.ComAtprotoRepoPutRecordBadRequestError$inboundSchema),
    M.jsonErr(
      401,
      errors.ComAtprotoRepoPutRecordAuthMissingError$inboundSchema,
    ),
