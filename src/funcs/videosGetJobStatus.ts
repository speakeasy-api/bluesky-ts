 ...
 */
export function videosGetJobStatus(
  client: BlueskyCore,
  request: operations.AppBskyVideoGetJobStatusRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppBskyVideoGetJobStatusResponse,
    | errors.AppBskyVideoGetJobStatusBadRequestError
    | errors.AppBskyVideoGetJobStatusAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppBskyVideoGetJobStatusResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.AppBskyVideoGetJobStatusBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyVideoGetJobStatusAuthMissingError$inboundSchema,
    ),
