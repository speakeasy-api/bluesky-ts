...
export function videosGetJobStatus(
  ...
  Result<
    ...
    | errors.BadRequestAppBskyVideoGetJobStatusResponseBodyError
    | errors.UnauthorizedAppBskyVideoGetJobStatusResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestAppBskyVideoGetJobStatusResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
