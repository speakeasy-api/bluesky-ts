...
export function graphGetList(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetListBadRequestError
      | errors.AppBskyGraphGetListAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.AppBskyGraphGetListBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyGraphGetListAuthMissingError$inboundSchema),
