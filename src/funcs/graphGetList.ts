...
export function graphGetList(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyGraphGetListResponseBodyError
      | errors.UnauthorizedAppBskyGraphGetListResponseBodyError
...
> {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyGraphGetListResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
      400,
      errors.BadRequestAppBskyGraphGetListResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedAppBskyGraphGetListResponseBodyError$inboundSchema,
    ),
