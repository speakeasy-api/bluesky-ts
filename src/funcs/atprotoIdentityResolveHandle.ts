...
export function atprotoIdentityResolveHandle(
  ...
  Result<
    ...
    | errors.ComAtprotoIdentityResolveHandleBadRequestError
    | errors.ComAtprotoIdentityResolveHandleAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoIdentityResolveHandleResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoIdentityResolveHandleBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoIdentityResolveHandleAuthMissingError$inboundSchema,
    ),
