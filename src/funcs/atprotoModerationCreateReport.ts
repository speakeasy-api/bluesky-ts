...
export function atprotoModerationCreateReport(
  ...
  Result<
    ...
    | errors.ComAtprotoModerationCreateReportBadRequestError
    | errors.ComAtprotoModerationCreateReportAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoModerationCreateReportRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoModerationCreateReportResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoModerationCreateReportBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoModerationCreateReportAuthMissingError$inboundSchema,
    ),
