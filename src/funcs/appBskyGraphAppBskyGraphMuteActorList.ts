 ...
 */
export async function appBskyGraphAppBskyGraphMuteActorList(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.AppBskyGraphMuteActorListAppBskyGraphResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.AppBskyGraphMuteActorListAppBskyGraphResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
