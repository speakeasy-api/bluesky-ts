 ...
 */
export async function comAtprotoIdentityComAtprotoIdentityRequestPlcOperationSignature(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoIdentityRequestPlcOperationSignatureComAtprotoIdentityResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
