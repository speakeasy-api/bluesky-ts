...
export function videosUpload(
  ...
  Result<
    ...
    | errors.BadRequestAppBskyVideoUploadVideoResponseBodyError
    | errors.UnauthorizedAppBskyVideoUploadVideoResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestAppBskyVideoUploadVideoResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedAppBskyVideoUploadVideoResponseBodyError$inboundSchema,
    ),
