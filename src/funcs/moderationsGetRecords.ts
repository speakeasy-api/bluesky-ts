...
export function moderationsGetRecords(
  ...
  Result<
    ...
    | errors.ToolsOzoneModerationGetRecordsBadRequestError
    | errors.ToolsOzoneModerationGetRecordsAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ToolsOzoneModerationGetRecordsResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ToolsOzoneModerationGetRecordsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneModerationGetRecordsAuthMissingError$inboundSchema,
    ),
