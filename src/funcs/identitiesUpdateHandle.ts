...
export function identitiesUpdateHandle(
  ...
  Result<
    void,
    | errors.ComAtprotoIdentityUpdateHandleBadRequestError
    | errors.ComAtprotoIdentityUpdateHandleAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoIdentityUpdateHandleRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/xrpc/com.atproto.identity.updateHandle")();
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoIdentityUpdateHandleBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoIdentityUpdateHandleAuthMissingError$inboundSchema,
    ),
