 ...
 */
export function serversGetServiceAuth(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoServerGetServiceAuthBadRequestError
    | errors.ComAtprotoServerGetServiceAuthAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerGetServiceAuthRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/xrpc/com.atproto.server.getServiceAuth")();
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoServerGetServiceAuthResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoServerGetServiceAuthBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerGetServiceAuthAuthMissingError$inboundSchema,
    ),
