...
export async function notificationsGetUnreadCount(
  ...
  Result<
    ...
    | errors.AppBskyNotificationGetUnreadCountResponseBody
    | errors.AppBskyNotificationGetUnreadCountNotificationsResponseBody
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
    | errors.BadRequest
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyNotificationGetUnreadCountResponseBody$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
