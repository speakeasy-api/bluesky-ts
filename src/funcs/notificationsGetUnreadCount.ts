...
export function notificationsGetUnreadCount(
  ...
  Result<
    ...
    | errors.AppBskyNotificationGetUnreadCountBadRequestError
    | errors.AppBskyNotificationGetUnreadCountAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.AppBskyNotificationGetUnreadCountResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.AppBskyNotificationGetUnreadCountBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyNotificationGetUnreadCountAuthMissingError$inboundSchema,
    ),
