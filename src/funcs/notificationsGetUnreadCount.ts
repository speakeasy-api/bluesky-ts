...
export function notificationsGetUnreadCount(
  ...
  Result<
    ...
    | errors.BadRequestAppBskyNotificationGetUnreadCountResponseBodyError
    | errors.UnauthorizedAppBskyNotificationGetUnreadCountResponseBodyError
...
> {
  ...
  >(
    M.json(
      200,
      operations.AppBskyNotificationGetUnreadCountResponseBody$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors
