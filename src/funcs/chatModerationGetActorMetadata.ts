...
export function chatModerationGetActorMetadata(
  ...
  Result<
    operations.ChatBskyModerationGetActorMetadataResponse,
    | errors.ChatBskyModerationGetActorMetadataBadRequestError
    | errors.ChatBskyModerationGetActorMetadataAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ChatBskyModerationGetActorMetadataResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ChatBskyModerationGetActorMetadataBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ChatBskyModerationGetActorMetadataAuthMissingError$inboundSchema,
    ),
