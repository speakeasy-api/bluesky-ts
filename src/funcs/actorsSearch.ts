...
export function actorsSearch(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyActorSearchActorsResponseBodyError
      | errors.UnauthorizedAppBskyActorSearchActorsResponseBodyError
...
> {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyActorSearchActorsResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
      400,
      errors.BadRequestAppBskyActorSearchActorsResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
