...
export function actorsSearch(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyActorSearchActorsBadRequestError
      | errors.AppBskyActorSearchActorsAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyActorSearchActorsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyActorSearchActorsAuthMissingError$inboundSchema,
    ),
