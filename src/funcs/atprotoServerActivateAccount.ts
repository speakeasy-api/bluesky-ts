 ...
 */
export function atprotoServerActivateAccount(
  client: BlueskyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    void,
    | errors.BadRequestComAtprotoServerActivateAccountResponseBodyError
    | errors.UnauthorizedComAtprotoServerActivateAccountResponseBodyError
...
> {
  const path = pathToFunc("/xrpc/com.atproto.server.activateAccount")();
