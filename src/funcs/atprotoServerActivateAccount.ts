...
export function atprotoServerActivateAccount(
  ...
  Result<
    void,
    | errors.ComAtprotoServerActivateAccountBadRequestError
    | errors.ComAtprotoServerActivateAccountAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoServerActivateAccountBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerActivateAccountAuthMissingError$inboundSchema,
    ),
