 ...
 */
export function ozoneServerGetConfig(
  client: BlueskyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ToolsOzoneServerGetConfigResponseBody,
    | errors.BadRequestToolsOzoneServerGetConfigResponseBodyError
    | errors.UnauthorizedToolsOzoneServerGetConfigResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestToolsOzoneServerGetConfigResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
