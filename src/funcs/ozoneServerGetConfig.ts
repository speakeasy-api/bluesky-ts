...
export function ozoneServerGetConfig(
  ...
  Result<
    ...
    | errors.ToolsOzoneServerGetConfigBadRequestError
    | errors.ToolsOzoneServerGetConfigAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToolsOzoneServerGetConfigResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ToolsOzoneServerGetConfigBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneServerGetConfigAuthMissingError$inboundSchema,
    ),
