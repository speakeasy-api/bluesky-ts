 ...
 */
export function serversUpdateEmail(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoServerUpdateEmailResponseBodyError
    | errors.UnauthorizedComAtprotoServerUpdateEmailResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerUpdateEmailBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/com.atproto.server.updateEmail")();
