...
export function serversUpdateEmail(
  ...
  Result<
    void,
    | errors.ComAtprotoServerUpdateEmailBadRequestError
    | errors.ComAtprotoServerUpdateEmailAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerUpdateEmailRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoServerUpdateEmailBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerUpdateEmailAuthMissingError$inboundSchema,
    ),
