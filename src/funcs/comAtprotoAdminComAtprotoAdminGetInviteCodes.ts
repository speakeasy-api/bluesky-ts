...
export async function comAtprotoAdminComAtprotoAdminGetInviteCodes(
  ...
  Result<
    operations.ComAtprotoAdminGetInviteCodesResponseBody,
    | errors.ComAtprotoAdminGetInviteCodesResponseBody
    | errors.ComAtprotoAdminGetInviteCodesComAtprotoAdminResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoAdminGetInviteCodesResponseBody$inboundSchema,
    ),
    M.jsonErr(
      400,
