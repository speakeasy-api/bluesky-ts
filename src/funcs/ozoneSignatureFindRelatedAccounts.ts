 ...
 */
export async function ozoneSignatureFindRelatedAccounts(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.ToolsOzoneSignatureFindRelatedAccountsOzoneSignatureResponseBody
      | APIError
      | SDKValidationError
      | UnexpectedClientError
      | InvalidRequestError
...
> {
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      ozoneSignatureFindRelatedAccounts(
        client,
        {
          ...request,
          cursor: nextCursor,
