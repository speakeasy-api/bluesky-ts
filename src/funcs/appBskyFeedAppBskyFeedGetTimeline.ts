...
export async function appBskyFeedAppBskyFeedGetTimeline(
  ...
  Result<
    operations.AppBskyFeedGetTimelineResponseBody,
    | errors.AppBskyFeedGetTimelineResponseBody
    | errors.AppBskyFeedGetTimelineAppBskyFeedResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyFeedGetTimelineResponseBody$inboundSchema),
    M.jsonErr(400, errors.AppBskyFeedGetTimelineResponseBody$inboundSchema),
    M.jsonErr(
      401,
      errors.AppBskyFeedGetTimelineAppBskyFeedResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
