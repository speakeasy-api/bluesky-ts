 ...
 */
export function ozoneAddMember(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ToolsOzoneTeamAddMemberBadRequestError
    | errors.ToolsOzoneTeamAddMemberAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneTeamAddMemberRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/tools.ozone.team.addMember")();
  ...
  >(
    ...
    M.jsonErr(400, errors.ToolsOzoneTeamAddMemberBadRequestError$inboundSchema),
    M.jsonErr(
      401,
      errors.ToolsOzoneTeamAddMemberAuthMissingError$inboundSchema,
    ),
