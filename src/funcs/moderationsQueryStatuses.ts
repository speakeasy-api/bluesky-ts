...
export function moderationsQueryStatuses(
  ...
  PageIterator<
    Result<
      ...
      | errors.ToolsOzoneModerationQueryStatusesBadRequestError
      | errors.ToolsOzoneModerationQueryStatusesAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneModerationQueryStatusesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneModerationQueryStatusesAuthMissingError$inboundSchema,
    ),
