...
export function feedGetTimeline(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetTimelineBadRequestError
      | errors.AppBskyFeedGetTimelineAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.AppBskyFeedGetTimelineBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyFeedGetTimelineAuthMissingError$inboundSchema),
