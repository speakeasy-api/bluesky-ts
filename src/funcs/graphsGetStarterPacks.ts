 ...
 */
export async function graphsGetStarterPacks(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.AppBskyGraphGetStarterPacksGraphsResponseBody
    | errors.NotFound
    | errors.Unauthorized
    | errors.Timeout
    | errors.RateLimited
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.AppBskyGraphGetStarterPacksGraphsResponseBody$inboundSchema,
    ),
