...
export function graphsGetStarterPacks(
  ...
  Result<
    ...
    | errors.BadRequestAppBskyGraphGetStarterPacksResponseBodyError
    | errors.UnauthorizedAppBskyGraphGetStarterPacksResponseBodyError
...
> {
  ...
  >(
    M.json(
      200,
      operations.AppBskyGraphGetStarterPacksResponseBody$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors
