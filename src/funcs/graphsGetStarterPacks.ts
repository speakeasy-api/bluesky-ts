 ...
 */
export function graphsGetStarterPacks(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.AppBskyGraphGetStarterPacksBadRequestError
    | errors.AppBskyGraphGetStarterPacksAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphGetStarterPacksRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/app.bsky.graph.getStarterPacks")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppBskyGraphGetStarterPacksResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.AppBskyGraphGetStarterPacksBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphGetStarterPacksAuthMissingError$inboundSchema,
    ),
