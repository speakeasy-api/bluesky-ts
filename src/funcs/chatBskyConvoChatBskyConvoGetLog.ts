...
export async function chatBskyConvoChatBskyConvoGetLog(
  ...
  Result<
    operations.ChatBskyConvoGetLogResponseBody,
    | errors.ChatBskyConvoGetLogResponseBody
    | errors.ChatBskyConvoGetLogChatBskyConvoResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ChatBskyConvoGetLogResponseBody$inboundSchema),
    M.jsonErr(400, errors.ChatBskyConvoGetLogResponseBody$inboundSchema),
    M.jsonErr(
      401,
      errors.ChatBskyConvoGetLogChatBskyConvoResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
