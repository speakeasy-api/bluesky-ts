 ...
 */
export function identitySubmitPlcOperation(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.ComAtprotoIdentitySubmitPlcOperationBadRequestError
    | errors.ComAtprotoIdentitySubmitPlcOperationAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoIdentitySubmitPlcOperationRequest$outboundSchema
        .parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoIdentitySubmitPlcOperationBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoIdentitySubmitPlcOperationAuthMissingError$inboundSchema,
    ),
