...
export function atprotoServerCreateAccount(
  ...
  Result<
    ...
    | errors.BadRequestComAtprotoServerCreateAccountResponseBodyError
    | errors.UnauthorizedComAtprotoServerCreateAccountResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerCreateAccountBody$outboundSchema.parse(value),
