 ...
 */
export function atprotoServerCreateAccount(
  client: BlueskyCore,
  request: operations.ComAtprotoServerCreateAccountRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComAtprotoServerCreateAccountResponse,
    | errors.ComAtprotoServerCreateAccountBadRequestError
    | errors.ComAtprotoServerCreateAccountAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerCreateAccountRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/xrpc/com.atproto.server.createAccount")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComAtprotoServerCreateAccountResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ComAtprotoServerCreateAccountBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerCreateAccountAuthMissingError$inboundSchema,
    ),
