 ...
 */
export async function adminUpdateAccountEmail(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoAdminUpdateAccountEmailAdminResponseBody
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
    | errors.BadRequest
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoAdminUpdateAccountEmailAdminResponseBody$inboundSchema,
    ),
