 ...
 */
export function feedsSendInteractions(
  client: BlueskyCore,
  request: operations.AppBskyFeedSendInteractionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppBskyFeedSendInteractionsResponse,
    | errors.AppBskyFeedSendInteractionsBadRequestError
    | errors.AppBskyFeedSendInteractionsAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyFeedSendInteractionsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppBskyFeedSendInteractionsResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.AppBskyFeedSendInteractionsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyFeedSendInteractionsAuthMissingError$inboundSchema,
    ),
