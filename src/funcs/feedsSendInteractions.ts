...
export function feedsSendInteractions(
  ...
  Result<
    ...
    | errors.BadRequestAppBskyFeedSendInteractionsResponseBodyError
    | errors.UnauthorizedAppBskyFeedSendInteractionsResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyFeedSendInteractionsBody$outboundSchema.parse(value),
