 ...
 */
export async function feedsSendInteractions(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.AppBskyFeedSendInteractionsFeedsResponseBody
    | errors.NotFound
    | errors.Unauthorized
    | errors.Timeout
    | errors.RateLimited
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.AppBskyFeedSendInteractionsFeedsResponseBody$inboundSchema,
    ),
