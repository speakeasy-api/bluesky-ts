...
export function notificationsRegisterPush(
  ...
  Result<
    void,
    | errors.BadRequestAppBskyNotificationRegisterPushResponseBodyError
    | errors.UnauthorizedAppBskyNotificationRegisterPushResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyNotificationRegisterPushBody$outboundSchema.parse(
        value,
      ),
