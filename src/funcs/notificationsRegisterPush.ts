 ...
 */
export function notificationsRegisterPush(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.AppBskyNotificationRegisterPushBadRequestError
    | errors.AppBskyNotificationRegisterPushAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyNotificationRegisterPushRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyNotificationRegisterPushBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyNotificationRegisterPushAuthMissingError$inboundSchema,
    ),
