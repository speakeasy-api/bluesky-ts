...
export function teamsUpdateMember(
  ...
  Result<
    ...
    | errors.BadRequestToolsOzoneTeamUpdateMemberResponseBodyError
    | errors.UnauthorizedToolsOzoneTeamUpdateMemberResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneTeamUpdateMemberBody$outboundSchema.parse(value),
