 ...
 */
export function teamsUpdateMember(
  client: BlueskyCore,
  request: operations.ToolsOzoneTeamUpdateMemberRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ToolsOzoneTeamDefsMember,
    | errors.ToolsOzoneTeamUpdateMemberBadRequestError
    | errors.ToolsOzoneTeamUpdateMemberAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneTeamUpdateMemberRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneTeamUpdateMemberBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneTeamUpdateMemberAuthMissingError$inboundSchema,
    ),
