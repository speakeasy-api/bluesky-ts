...
export function feedGetActorLikes(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyFeedGetActorLikesResponseBodyError
      | errors.UnauthorizedAppBskyFeedGetActorLikesResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestAppBskyFeedGetActorLikesResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
