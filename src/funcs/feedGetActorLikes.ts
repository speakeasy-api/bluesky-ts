...
export function feedGetActorLikes(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetActorLikesBadRequestError
      | errors.AppBskyFeedGetActorLikesAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyFeedGetActorLikesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyFeedGetActorLikesAuthMissingError$inboundSchema,
    ),
