...
export function convoList(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestChatBskyConvoListConvosResponseBodyError
      | errors.UnauthorizedChatBskyConvoListConvosResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestChatBskyConvoListConvosResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedChatBskyConvoListConvosResponseBodyError$inboundSchema,
    ),
