...
export function convoList(
  ...
  PageIterator<
    Result<
      ...
      | errors.ChatBskyConvoListConvosBadRequestError
      | errors.ChatBskyConvoListConvosAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.ChatBskyConvoListConvosBadRequestError$inboundSchema),
    M.jsonErr(
      401,
      errors.ChatBskyConvoListConvosAuthMissingError$inboundSchema,
    ),
