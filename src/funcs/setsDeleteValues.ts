 ...
 */
export function setsDeleteValues(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.ToolsOzoneSetDeleteValuesBadRequestError
    | errors.ToolsOzoneSetDeleteValuesAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneSetDeleteValuesRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneSetDeleteValuesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneSetDeleteValuesAuthMissingError$inboundSchema,
    ),
