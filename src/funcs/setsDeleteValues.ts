...
export function setsDeleteValues(
  ...
  Result<
    void,
    | errors.BadRequestToolsOzoneSetDeleteValuesResponseBodyError
    | errors.UnauthorizedToolsOzoneSetDeleteValuesResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneSetDeleteValuesBody$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestToolsOzoneSetDeleteValuesResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
