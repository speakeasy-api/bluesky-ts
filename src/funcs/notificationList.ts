...
export function notificationList(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyNotificationListNotificationsBadRequestError
      | errors.AppBskyNotificationListNotificationsAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.AppBskyNotificationListNotificationsResponse$inboundSchema,
      { key: "Result" },
    ),
    M.jsonErr(
      400,
      errors.AppBskyNotificationListNotificationsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyNotificationListNotificationsAuthMissingError$inboundSchema,
    ),
