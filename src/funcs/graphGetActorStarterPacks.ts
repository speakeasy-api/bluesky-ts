 ...
 */
export function graphGetActorStarterPacks(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetActorStarterPacksBadRequestError
      | errors.AppBskyGraphGetActorStarterPacksAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyGraphGetActorStarterPacksBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphGetActorStarterPacksAuthMissingError$inboundSchema,
    ),
