...
export function syncsGetBlocks(
  ...
  Result<
    void,
    | errors.ComAtprotoSyncGetBlocksBadRequestError
    | errors.ComAtprotoSyncGetBlocksAuthMissingError
...
> {
  ...
  >(
    M.nil(200, z.void()),
    M.jsonErr(400, errors.ComAtprotoSyncGetBlocksBadRequestError$inboundSchema),
    M.jsonErr(
      401,
      errors.ComAtprotoSyncGetBlocksAuthMissingError$inboundSchema,
    ),
