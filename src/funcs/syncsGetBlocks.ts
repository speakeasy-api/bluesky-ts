 ...
 */
export function syncsGetBlocks(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoSyncGetBlocksResponseBodyError
    | errors.UnauthorizedComAtprotoSyncGetBlocksResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestComAtprotoSyncGetBlocksResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedComAtprotoSyncGetBlocksResponseBodyError$inboundSchema,
    ),
