 ...
 */
export function adminUpdateSubjectStatus(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoAdminUpdateSubjectStatusBadRequestError
    | errors.ComAtprotoAdminUpdateSubjectStatusAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminUpdateSubjectStatusRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoAdminUpdateSubjectStatusResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoAdminUpdateSubjectStatusBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminUpdateSubjectStatusAuthMissingError$inboundSchema,
    ),
