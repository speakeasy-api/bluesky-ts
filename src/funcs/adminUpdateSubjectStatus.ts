 ...
 */
export async function adminUpdateSubjectStatus(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoAdminUpdateSubjectStatusAdminResponseBody
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
    | errors.BadRequest
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoAdminUpdateSubjectStatusAdminResponseBody$inboundSchema,
    ),
