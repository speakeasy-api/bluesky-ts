...
export function reposGetRecord(
  ...
  Result<
    ...
    | errors.BadRequestComAtprotoRepoGetRecordResponseBodyError
    | errors.UnauthorizedComAtprotoRepoGetRecordResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestComAtprotoRepoGetRecordResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedComAtprotoRepoGetRecordResponseBodyError$inboundSchema,
    ),
