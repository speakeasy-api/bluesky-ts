 ...
 */
export function reposGetRecord(
  client: BlueskyCore,
  request: operations.ComAtprotoRepoGetRecordRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComAtprotoRepoGetRecordResponse,
    | errors.ComAtprotoRepoGetRecordBadRequestError
    | errors.ComAtprotoRepoGetRecordAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComAtprotoRepoGetRecordResponse$inboundSchema),
    M.jsonErr(400, errors.ComAtprotoRepoGetRecordBadRequestError$inboundSchema),
    M.jsonErr(
      401,
      errors.ComAtprotoRepoGetRecordAuthMissingError$inboundSchema,
    ),
