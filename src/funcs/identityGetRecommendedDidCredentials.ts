 ...
 */
export function identityGetRecommendedDidCredentials(
  client: BlueskyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComAtprotoIdentityGetRecommendedDidCredentialsResponse,
    | errors.ComAtprotoIdentityGetRecommendedDidCredentialsBadRequestError
    | errors.ComAtprotoIdentityGetRecommendedDidCredentialsAuthMissingError
