...
export function atprotoServerCreateAppPassword(
  ...
  Result<
    ...
    | errors.BadRequestComAtprotoServerCreateAppPasswordResponseBodyError
    | errors.UnauthorizedComAtprotoServerCreateAppPasswordResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerCreateAppPasswordBody$outboundSchema.parse(
        value,
      ),
