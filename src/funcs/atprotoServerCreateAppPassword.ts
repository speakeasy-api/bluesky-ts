...
export function atprotoServerCreateAppPassword(
  ...
  Result<
    ...
    | errors.ComAtprotoServerCreateAppPasswordBadRequestError
    | errors.ComAtprotoServerCreateAppPasswordAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerCreateAppPasswordRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoServerCreateAppPasswordBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerCreateAppPasswordAuthMissingError$inboundSchema,
    ),
