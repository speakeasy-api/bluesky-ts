 ...
 */
export function serversGetSession(
  client: BlueskyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComAtprotoServerGetSessionResponse,
    | errors.ComAtprotoServerGetSessionBadRequestError
    | errors.ComAtprotoServerGetSessionAuthMissingError
...
> {
  const path = pathToFunc("/xrpc/com.atproto.server.getSession")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComAtprotoServerGetSessionResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ComAtprotoServerGetSessionBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerGetSessionAuthMissingError$inboundSchema,
    ),
