 ...
 */
export async function serversGetSession(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoServerGetSessionServersResponseBody
    | errors.NotFound
    | errors.Unauthorized
    | errors.Timeout
    | errors.RateLimited
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoServerGetSessionServersResponseBody$inboundSchema,
    ),
