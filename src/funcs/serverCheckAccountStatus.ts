 ...
 */
export function serverCheckAccountStatus(
  client: BlueskyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComAtprotoServerCheckAccountStatusResponse,
    | errors.ComAtprotoServerCheckAccountStatusBadRequestError
    | errors.ComAtprotoServerCheckAccountStatusAuthMissingError
...
> {
  const path = pathToFunc("/xrpc/com.atproto.server.checkAccountStatus")();
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoServerCheckAccountStatusResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoServerCheckAccountStatusBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerCheckAccountStatusAuthMissingError$inboundSchema,
    ),
