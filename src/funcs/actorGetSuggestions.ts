 ...
 */
export function actorGetSuggestions(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyActorGetSuggestionsResponseBodyError
      | errors.UnauthorizedAppBskyActorGetSuggestionsResponseBodyError
