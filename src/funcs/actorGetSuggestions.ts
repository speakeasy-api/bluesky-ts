...
export function actorGetSuggestions(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyActorGetSuggestionsBadRequestError
      | errors.AppBskyActorGetSuggestionsAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyActorGetSuggestionsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyActorGetSuggestionsAuthMissingError$inboundSchema,
    ),
