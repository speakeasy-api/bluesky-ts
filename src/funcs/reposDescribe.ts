...
export function reposDescribe(
  ...
  Result<
    ...
    | errors.ComAtprotoRepoDescribeRepoBadRequestError
    | errors.ComAtprotoRepoDescribeRepoAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComAtprotoRepoDescribeRepoResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ComAtprotoRepoDescribeRepoBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoRepoDescribeRepoAuthMissingError$inboundSchema,
    ),
