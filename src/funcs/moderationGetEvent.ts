...
export function moderationGetEvent(
  ...
  Result<
    ...
    | errors.ToolsOzoneModerationGetEventBadRequestError
    | errors.ToolsOzoneModerationGetEventAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneModerationGetEventBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneModerationGetEventAuthMissingError$inboundSchema,
    ),
