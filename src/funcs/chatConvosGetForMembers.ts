...
export function chatConvosGetForMembers(
  ...
  Result<
    ...
    | errors.ChatBskyConvoGetConvoForMembersBadRequestError
    | errors.ChatBskyConvoGetConvoForMembersAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ChatBskyConvoGetConvoForMembersResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ChatBskyConvoGetConvoForMembersBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ChatBskyConvoGetConvoForMembersAuthMissingError$inboundSchema,
    ),
