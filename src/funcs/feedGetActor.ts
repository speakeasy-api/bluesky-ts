...
export function feedGetActor(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyFeedGetActorFeedsResponseBodyError
      | errors.UnauthorizedAppBskyFeedGetActorFeedsResponseBodyError
...
> {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyFeedGetActorFeedsResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
      400,
      errors.BadRequestAppBskyFeedGetActorFeedsResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
