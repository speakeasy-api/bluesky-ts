...
export function feedGetActor(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetActorFeedsBadRequestError
      | errors.AppBskyFeedGetActorFeedsAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyFeedGetActorFeedsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyFeedGetActorFeedsAuthMissingError$inboundSchema,
    ),
