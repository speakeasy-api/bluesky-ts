 ...
 */
export function atprotoSyncsGetRecord(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoSyncGetRecordResponseBodyError
    | errors.UnauthorizedComAtprotoSyncGetRecordResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoSyncGetRecordRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/com.atproto.sync.getRecord")();
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestComAtprotoSyncGetRecordResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedComAtprotoSyncGetRecordResponseBodyError$inboundSchema,
    ),
