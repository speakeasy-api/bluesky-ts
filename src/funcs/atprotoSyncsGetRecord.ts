...
export function atprotoSyncsGetRecord(
  ...
  Result<
    void,
    | errors.ComAtprotoSyncGetRecordBadRequestError
    | errors.ComAtprotoSyncGetRecordAuthMissingError
...
> {
  ...
  >(
    M.nil(200, z.void()),
    M.jsonErr(400, errors.ComAtprotoSyncGetRecordBadRequestError$inboundSchema),
    M.jsonErr(
      401,
      errors.ComAtprotoSyncGetRecordAuthMissingError$inboundSchema,
    ),
