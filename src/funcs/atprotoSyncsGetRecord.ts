 ...
 */
export async function atprotoSyncsGetRecord(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoSyncGetRecordAtprotoSyncsResponseBody
    | errors.NotFound
    | errors.Unauthorized
    | errors.Timeout
    | errors.RateLimited
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoSyncGetRecordAtprotoSyncsResponseBody$inboundSchema,
    ),
