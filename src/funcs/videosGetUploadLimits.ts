 ...
 */
export async function videosGetUploadLimits(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.AppBskyVideoGetUploadLimitsVideosResponseBody
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
    | errors.BadRequest
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.AppBskyVideoGetUploadLimitsVideosResponseBody$inboundSchema,
    ),
