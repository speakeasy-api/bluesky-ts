...
export function graphMuteActorList(
  ...
  Result<
    void,
    | errors.AppBskyGraphMuteActorListBadRequestError
    | errors.AppBskyGraphMuteActorListAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyGraphMuteActorListRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/app.bsky.graph.muteActorList")();
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyGraphMuteActorListBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphMuteActorListAuthMissingError$inboundSchema,
    ),
