...
export function ozoneModerationsSearchRepos(
  ...
  PageIterator<
    Result<
      ...
      | errors.ToolsOzoneModerationSearchReposBadRequestError
      | errors.ToolsOzoneModerationSearchReposAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneModerationSearchReposBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneModerationSearchReposAuthMissingError$inboundSchema,
    ),
