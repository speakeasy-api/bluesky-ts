 ...
 */
export async function ozoneModerationsSearchRepos(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.ToolsOzoneModerationSearchReposOzoneModerationsResponseBody
      | errors.Unauthorized
      | errors.NotFound
      | errors.Timeout
      | errors.BadRequest
...
> {
  ...
  >(
    M.json(
      200,
      operations.ToolsOzoneModerationSearchReposResponse$inboundSchema,
      { key: "Result" },
    ),
    M.jsonErr(
      400,
