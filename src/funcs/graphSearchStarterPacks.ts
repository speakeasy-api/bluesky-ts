...
export function graphSearchStarterPacks(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphSearchStarterPacksBadRequestError
      | errors.AppBskyGraphSearchStarterPacksAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyGraphSearchStarterPacksBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphSearchStarterPacksAuthMissingError$inboundSchema,
    ),
