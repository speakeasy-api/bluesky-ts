 ...
 */
export function graphSearchStarterPacks(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyGraphSearchStarterPacksResponseBodyError
      | errors.UnauthorizedAppBskyGraphSearchStarterPacksResponseBodyError
...
> {
  ...
  >(
    M.json(
      200,
      operations.AppBskyGraphSearchStarterPacksResponse$inboundSchema,
      { key: "Result" },
    ),
    M.jsonErr(
      400,
