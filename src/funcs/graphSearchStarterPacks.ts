 ...
 */
export async function graphSearchStarterPacks(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphSearchStarterPacksGraphResponseBody
      | APIError
      | SDKValidationError
      | UnexpectedClientError
      | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.AppBskyGraphSearchStarterPacksGraphResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
