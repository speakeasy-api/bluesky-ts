 ...
 */
export function adminsEnableAccountInvites(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.ComAtprotoAdminEnableAccountInvitesBadRequestError
    | errors.ComAtprotoAdminEnableAccountInvitesAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminEnableAccountInvitesRequest$outboundSchema
        .parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoAdminEnableAccountInvitesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminEnableAccountInvitesAuthMissingError$inboundSchema,
    ),
