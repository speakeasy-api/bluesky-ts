...
export function adminsEnableAccountInvites(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoAdminEnableAccountInvitesResponseBodyError
    | errors.UnauthorizedComAtprotoAdminEnableAccountInvitesResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminEnableAccountInvitesBody$outboundSchema.parse(
        value,
      ),
