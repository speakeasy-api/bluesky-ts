 ...
 */
export function feedGetSuggested(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyFeedGetSuggestedFeedsResponseBodyError
      | errors.UnauthorizedAppBskyFeedGetSuggestedFeedsResponseBodyError
...
> {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyFeedGetSuggestedFeedsResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
      400,
