...
export function feedGetSuggested(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetSuggestedFeedsBadRequestError
      | errors.AppBskyFeedGetSuggestedFeedsAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyFeedGetSuggestedFeedsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyFeedGetSuggestedFeedsAuthMissingError$inboundSchema,
    ),
