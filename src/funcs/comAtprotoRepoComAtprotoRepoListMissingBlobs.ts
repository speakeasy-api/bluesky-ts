...
export async function comAtprotoRepoComAtprotoRepoListMissingBlobs(
  ...
  Result<
    operations.ComAtprotoRepoListMissingBlobsResponseBody,
    | errors.ComAtprotoRepoListMissingBlobsResponseBody
    | errors.ComAtprotoRepoListMissingBlobsComAtprotoRepoResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoRepoListMissingBlobsResponseBody$inboundSchema,
    ),
    M.jsonErr(
      400,
