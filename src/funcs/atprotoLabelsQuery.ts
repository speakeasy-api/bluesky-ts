 ...
 */
export function atprotoLabelsQuery(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.ComAtprotoLabelQueryLabelsBadRequestError
      | errors.ComAtprotoLabelQueryLabelsAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoLabelQueryLabelsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoLabelQueryLabelsAuthMissingError$inboundSchema,
    ),
