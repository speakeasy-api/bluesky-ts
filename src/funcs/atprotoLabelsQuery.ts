 ...
 */
export async function atprotoLabelsQuery(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.ComAtprotoLabelQueryLabelsAtprotoLabelsResponseBody
      | errors.Unauthorized
      | errors.NotFound
      | errors.Timeout
      | errors.BadRequest
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoLabelQueryLabelsAtprotoLabelsResponseBody$inboundSchema,
    ),
