 ...
 */
export async function serverListAppPasswords(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoServerListAppPasswordsServerResponseBody
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
    | errors.BadRequest
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoServerListAppPasswordsServerResponseBody$inboundSchema,
    ),
