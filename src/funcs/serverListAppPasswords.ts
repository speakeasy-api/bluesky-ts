...
export function serverListAppPasswords(
  ...
  Result<
    ...
    | errors.ComAtprotoServerListAppPasswordsBadRequestError
    | errors.ComAtprotoServerListAppPasswordsAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoServerListAppPasswordsResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoServerListAppPasswordsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerListAppPasswordsAuthMissingError$inboundSchema,
    ),
