 ...
 */
export function notificationsUpdateSeen(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.AppBskyNotificationUpdateSeenBadRequestError
    | errors.AppBskyNotificationUpdateSeenAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyNotificationUpdateSeenRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyNotificationUpdateSeenBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyNotificationUpdateSeenAuthMissingError$inboundSchema,
    ),
