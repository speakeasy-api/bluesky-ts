...
export function notificationsUpdateSeen(
  ...
  Result<
    void,
    | errors.BadRequestAppBskyNotificationUpdateSeenResponseBodyError
    | errors.UnauthorizedAppBskyNotificationUpdateSeenResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyNotificationUpdateSeenBody$outboundSchema.parse(value),
