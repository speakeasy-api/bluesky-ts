 ...
 */
export function accountExportData(
  client: BlueskyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    void,
    | errors.ChatBskyActorExportAccountDataBadRequestError
    | errors.ChatBskyActorExportAccountDataAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ChatBskyActorExportAccountDataBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ChatBskyActorExportAccountDataAuthMissingError$inboundSchema,
    ),
