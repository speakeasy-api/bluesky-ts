...
export function atprotoIdentitySignPlcOperation(
  ...
  Result<
    ...
    | errors.ComAtprotoIdentitySignPlcOperationBadRequestError
    | errors.ComAtprotoIdentitySignPlcOperationAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoIdentitySignPlcOperationRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoIdentitySignPlcOperationResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoIdentitySignPlcOperationBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoIdentitySignPlcOperationAuthMissingError$inboundSchema,
    ),
