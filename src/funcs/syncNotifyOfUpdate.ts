 ...
 */
export function syncNotifyOfUpdate(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.ComAtprotoSyncNotifyOfUpdateBadRequestError
    | errors.ComAtprotoSyncNotifyOfUpdateAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoSyncNotifyOfUpdateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/xrpc/com.atproto.sync.notifyOfUpdate")();
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoSyncNotifyOfUpdateBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoSyncNotifyOfUpdateAuthMissingError$inboundSchema,
    ),
