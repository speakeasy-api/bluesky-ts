...
export function syncNotifyOfUpdate(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoSyncNotifyOfUpdateResponseBodyError
    | errors.UnauthorizedComAtprotoSyncNotifyOfUpdateResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoSyncNotifyOfUpdateBody$outboundSchema.parse(value),
