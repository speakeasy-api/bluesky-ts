 ...
 */
export function feedGetGenerator(
  client: BlueskyCore,
  request: operations.AppBskyFeedGetFeedGeneratorRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppBskyFeedGetFeedGeneratorResponse,
    | errors.AppBskyFeedGetFeedGeneratorBadRequestError
    | errors.AppBskyFeedGetFeedGeneratorAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyFeedGetFeedGeneratorRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/app.bsky.feed.getFeedGenerator")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppBskyFeedGetFeedGeneratorResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.AppBskyFeedGetFeedGeneratorBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyFeedGetFeedGeneratorAuthMissingError$inboundSchema,
    ),
