...
export function feedGetGenerator(
  ...
  Result<
    ...
    | errors.BadRequestAppBskyFeedGetFeedGeneratorResponseBodyError
    | errors.UnauthorizedAppBskyFeedGetFeedGeneratorResponseBodyError
...
> {
  ...
  >(
    M.json(
      200,
      operations.AppBskyFeedGetFeedGeneratorResponseBody$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors
