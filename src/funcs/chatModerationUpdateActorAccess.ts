 ...
 */
export function chatModerationUpdateActorAccess(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.ChatBskyModerationUpdateActorAccessBadRequestError
    | errors.ChatBskyModerationUpdateActorAccessAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChatBskyModerationUpdateActorAccessRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/xrpc/chat.bsky.moderation.updateActorAccess")();
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ChatBskyModerationUpdateActorAccessBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ChatBskyModerationUpdateActorAccessAuthMissingError$inboundSchema,
    ),
