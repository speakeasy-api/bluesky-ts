...
export function syncListBlobs(
  ...
  PageIterator<
    Result<
      ...
      | errors.ComAtprotoSyncListBlobsBadRequestError
      | errors.ComAtprotoSyncListBlobsAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.ComAtprotoSyncListBlobsBadRequestError$inboundSchema),
    M.jsonErr(
      401,
      errors.ComAtprotoSyncListBlobsAuthMissingError$inboundSchema,
    ),
