...
export function serverDeactivateAccount(
  ...
  Result<
    void,
    | errors.ComAtprotoServerDeactivateAccountBadRequestError
    | errors.ComAtprotoServerDeactivateAccountAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoServerDeactivateAccountRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoServerDeactivateAccountBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerDeactivateAccountAuthMissingError$inboundSchema,
    ),
