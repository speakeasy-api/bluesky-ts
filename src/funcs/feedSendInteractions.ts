 ...
 */
export async function feedSendInteractions(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.AppBskyFeedSendInteractionsFeedResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.AppBskyFeedSendInteractionsFeedResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
