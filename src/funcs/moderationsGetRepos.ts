 ...
 */
export function moderationsGetRepos(
  client: BlueskyCore,
  request: operations.ToolsOzoneModerationGetReposRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ToolsOzoneModerationGetReposResponse,
    | errors.ToolsOzoneModerationGetReposBadRequestError
    | errors.ToolsOzoneModerationGetReposAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneModerationGetReposRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/xrpc/tools.ozone.moderation.getRepos")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToolsOzoneModerationGetReposResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ToolsOzoneModerationGetReposBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneModerationGetReposAuthMissingError$inboundSchema,
    ),
