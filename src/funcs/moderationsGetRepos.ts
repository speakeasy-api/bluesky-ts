 ...
 */
export async function moderationsGetRepos(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ToolsOzoneModerationGetReposModerationsResponseBody
    | errors.NotFound
    | errors.Unauthorized
    | errors.Timeout
    | errors.RateLimited
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ToolsOzoneModerationGetReposModerationsResponseBody$inboundSchema,
    ),
