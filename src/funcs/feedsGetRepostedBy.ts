...
export function feedsGetRepostedBy(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetRepostedByBadRequestError
      | errors.AppBskyFeedGetRepostedByAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyFeedGetRepostedByBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyFeedGetRepostedByAuthMissingError$inboundSchema,
    ),
