 ...
 */
export function feedsGetRepostedBy(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyFeedGetRepostedByResponseBodyError
      | errors.UnauthorizedAppBskyFeedGetRepostedByResponseBodyError
...
> {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyFeedGetRepostedByResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
      400,
      errors.BadRequestAppBskyFeedGetRepostedByResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
