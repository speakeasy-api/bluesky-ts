 ...
 */
export async function feedsGetRepostedBy(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetRepostedByFeedsResponseBody
      | errors.NotFound
      | errors.Unauthorized
      | errors.Timeout
      | errors.RateLimited
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.AppBskyFeedGetRepostedByFeedsResponseBody$inboundSchema,
    ),
