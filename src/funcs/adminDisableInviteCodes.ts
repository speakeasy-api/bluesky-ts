...
export function adminDisableInviteCodes(
  client: BlueskyCore,
  request: operations.ComAtprotoAdminDisableInviteCodesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    void,
    | errors.ComAtprotoAdminDisableInviteCodesBadRequestError
    | errors.ComAtprotoAdminDisableInviteCodesAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminDisableInviteCodesRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoAdminDisableInviteCodesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminDisableInviteCodesAuthMissingError$inboundSchema,
    ),
