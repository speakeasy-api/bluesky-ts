...
export function chatsGetConvo(
  ...
  Result<
    ...
    | errors.BadRequestChatBskyConvoGetConvoResponseBodyError
    | errors.UnauthorizedChatBskyConvoGetConvoResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestChatBskyConvoGetConvoResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedChatBskyConvoGetConvoResponseBodyError$inboundSchema,
    ),
