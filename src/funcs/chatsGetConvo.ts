 ...
 */
export function chatsGetConvo(
  client: BlueskyCore,
  request: operations.ChatBskyConvoGetConvoRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ChatBskyConvoGetConvoResponse,
    | errors.ChatBskyConvoGetConvoBadRequestError
    | errors.ChatBskyConvoGetConvoAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChatBskyConvoGetConvoRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/chat.bsky.convo.getConvo")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ChatBskyConvoGetConvoResponse$inboundSchema),
    M.jsonErr(400, errors.ChatBskyConvoGetConvoBadRequestError$inboundSchema),
    M.jsonErr(401, errors.ChatBskyConvoGetConvoAuthMissingError$inboundSchema),
