...
export function atprotoRepoImport(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoRepoImportRepoResponseBodyError
    | errors.UnauthorizedComAtprotoRepoImportRepoResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestComAtprotoRepoImportRepoResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
