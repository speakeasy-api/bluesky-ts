 ...
 */
export function atprotoRepoImport(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.ComAtprotoRepoImportRepoBadRequestError
    | errors.ComAtprotoRepoImportRepoAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoRepoImportRepoBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoRepoImportRepoAuthMissingError$inboundSchema,
    ),
