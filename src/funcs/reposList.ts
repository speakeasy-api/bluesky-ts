...
export function reposList(
  ...
  PageIterator<
    Result<
      ...
      | errors.ComAtprotoRepoListRecordsBadRequestError
      | errors.ComAtprotoRepoListRecordsAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoRepoListRecordsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoRepoListRecordsAuthMissingError$inboundSchema,
    ),
