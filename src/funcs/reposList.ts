...
export function reposList(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestComAtprotoRepoListRecordsResponseBodyError
      | errors.UnauthorizedComAtprotoRepoListRecordsResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestComAtprotoRepoListRecordsResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
