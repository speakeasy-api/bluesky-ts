 ...
 */
export function actorsPutPreferences(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.BadRequestAppBskyActorPutPreferencesResponseBodyError
    | errors.UnauthorizedAppBskyActorPutPreferencesResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyActorPutPreferencesBody$outboundSchema.parse(value),
