...
export function actorsPutPreferences(
  ...
  Result<
    void,
    | errors.AppBskyActorPutPreferencesBadRequestError
    | errors.AppBskyActorPutPreferencesAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppBskyActorPutPreferencesRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyActorPutPreferencesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyActorPutPreferencesAuthMissingError$inboundSchema,
    ),
