 ...
 */
export function ozoneCommunicationDelete(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.BadRequestToolsOzoneCommunicationDeleteTemplateResponseBodyError
    | errors.UnauthorizedToolsOzoneCommunicationDeleteTemplateResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneCommunicationDeleteTemplateBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/xrpc/tools.ozone.communication.deleteTemplate")();
