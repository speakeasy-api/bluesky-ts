...
export function ozoneCommunicationDelete(
  ...
  Result<
    void,
    | errors.ToolsOzoneCommunicationDeleteTemplateBadRequestError
    | errors.ToolsOzoneCommunicationDeleteTemplateAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneCommunicationDeleteTemplateRequest$outboundSchema
        .parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneCommunicationDeleteTemplateBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
