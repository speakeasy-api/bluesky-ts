...
export function atprotoRepoUploadBlob(
  ...
  Result<
    ...
    | errors.ComAtprotoRepoUploadBlobBadRequestError
    | errors.ComAtprotoRepoUploadBlobAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComAtprotoRepoUploadBlobResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ComAtprotoRepoUploadBlobBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoRepoUploadBlobAuthMissingError$inboundSchema,
    ),
