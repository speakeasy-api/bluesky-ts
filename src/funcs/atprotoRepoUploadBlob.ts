 ...
 */
export function atprotoRepoUploadBlob(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.BadRequestComAtprotoRepoUploadBlobResponseBodyError
    | errors.UnauthorizedComAtprotoRepoUploadBlobResponseBodyError
...
> {
  ...
  const path = pathToFunc("/xrpc/com.atproto.repo.uploadBlob")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ComAtprotoRepoUploadBlobResponseBody$inboundSchema),
    M.jsonErr(
      400,
      errors.BadRequestComAtprotoRepoUploadBlobResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
