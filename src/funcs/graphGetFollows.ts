...
export function graphGetFollows(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetFollowsBadRequestError
      | errors.AppBskyGraphGetFollowsAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.AppBskyGraphGetFollowsBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyGraphGetFollowsAuthMissingError$inboundSchema),
