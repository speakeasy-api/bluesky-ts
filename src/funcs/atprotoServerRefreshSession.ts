 ...
 */
export function atprotoServerRefreshSession(
  client: BlueskyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComAtprotoServerRefreshSessionResponse,
    | errors.ComAtprotoServerRefreshSessionBadRequestError
    | errors.ComAtprotoServerRefreshSessionAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoServerRefreshSessionResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoServerRefreshSessionBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoServerRefreshSessionAuthMissingError$inboundSchema,
    ),
