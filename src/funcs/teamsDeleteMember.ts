...
export function teamsDeleteMember(
  ...
  Result<
    void,
    | errors.BadRequestToolsOzoneTeamDeleteMemberResponseBodyError
    | errors.UnauthorizedToolsOzoneTeamDeleteMemberResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneTeamDeleteMemberBody$outboundSchema.parse(value),
