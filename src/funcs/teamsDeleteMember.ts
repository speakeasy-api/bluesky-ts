 ...
 */
export function teamsDeleteMember(
  client: BlueskyCore,
  request: operations.ToolsOzoneTeamDeleteMemberRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    void,
    | errors.ToolsOzoneTeamDeleteMemberBadRequestError
    | errors.ToolsOzoneTeamDeleteMemberAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneTeamDeleteMemberRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ToolsOzoneTeamDeleteMemberBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ToolsOzoneTeamDeleteMemberAuthMissingError$inboundSchema,
    ),
