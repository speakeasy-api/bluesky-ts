 ...
 */
export async function teamsDeleteMember(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ToolsOzoneTeamDeleteMemberTeamsResponseBody
    | errors.NotFound
    | errors.Unauthorized
    | errors.Timeout
    | errors.RateLimited
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ToolsOzoneTeamDeleteMemberTeamsResponseBody$inboundSchema,
    ),
