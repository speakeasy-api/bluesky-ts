 ...
 */
export async function chatActorDeleteAccount(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ChatBskyActorDeleteAccountChatActorResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ChatBskyActorDeleteAccountChatActorResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
