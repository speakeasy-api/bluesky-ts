 ...
 */
export function accountsGetInviteCodes(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoServerGetAccountInviteCodesBadRequestError
    | errors.ComAtprotoServerGetAccountInviteCodesAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoServerGetAccountInviteCodesResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoServerGetAccountInviteCodesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
