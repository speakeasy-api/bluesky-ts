 ...
 */
export async function appBskyFeedAppBskyFeedGetLikes(
  client: BlueskyCore,
  request: operations.AppBskyFeedGetLikesRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.AppBskyFeedGetLikesResponseBody,
    | errors.AppBskyFeedGetLikesResponseBody
    | errors.AppBskyFeedGetLikesAppBskyFeedResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyFeedGetLikesResponseBody$inboundSchema),
    M.jsonErr(400, errors.AppBskyFeedGetLikesResponseBody$inboundSchema),
    M.jsonErr(
      401,
      errors.AppBskyFeedGetLikesAppBskyFeedResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
