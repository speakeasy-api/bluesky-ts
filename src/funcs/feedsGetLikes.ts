...
export function feedsGetLikes(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyFeedGetLikesBadRequestError
      | errors.AppBskyFeedGetLikesAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.AppBskyFeedGetLikesBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyFeedGetLikesAuthMissingError$inboundSchema),
