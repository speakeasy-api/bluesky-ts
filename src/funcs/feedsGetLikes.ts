...
export function feedsGetLikes(
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyFeedGetLikesResponseBodyError
      | errors.UnauthorizedAppBskyFeedGetLikesResponseBodyError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestAppBskyFeedGetLikesResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedAppBskyFeedGetLikesResponseBodyError$inboundSchema,
    ),
