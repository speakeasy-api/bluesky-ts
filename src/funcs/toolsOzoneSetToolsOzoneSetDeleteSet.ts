 ...
 */
export async function toolsOzoneSetToolsOzoneSetDeleteSet(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ToolsOzoneSetDeleteSetToolsOzoneSetResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsOzoneSetDeleteSetRequestBody$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ToolsOzoneSetDeleteSetToolsOzoneSetResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
