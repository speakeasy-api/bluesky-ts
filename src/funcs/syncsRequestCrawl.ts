...
export function syncsRequestCrawl(
  ...
  Result<
    void,
    | errors.ComAtprotoSyncRequestCrawlBadRequestError
    | errors.ComAtprotoSyncRequestCrawlAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoSyncRequestCrawlRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoSyncRequestCrawlBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoSyncRequestCrawlAuthMissingError$inboundSchema,
    ),
