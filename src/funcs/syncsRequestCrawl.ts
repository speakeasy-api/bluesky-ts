...
export function syncsRequestCrawl(
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoSyncRequestCrawlResponseBodyError
    | errors.UnauthorizedComAtprotoSyncRequestCrawlResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoSyncRequestCrawlBody$outboundSchema.parse(value),
