...
export function feedGetGenerators(
  ...
  Result<
    ...
    | errors.AppBskyFeedGetFeedGeneratorsBadRequestError
    | errors.AppBskyFeedGetFeedGeneratorsAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppBskyFeedGetFeedGeneratorsResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.AppBskyFeedGetFeedGeneratorsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyFeedGetFeedGeneratorsAuthMissingError$inboundSchema,
    ),
