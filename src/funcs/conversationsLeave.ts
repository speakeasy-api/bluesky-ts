...
export function conversationsLeave(
  ...
  Result<
    ...
    | errors.ChatBskyConvoLeaveConvoBadRequestError
    | errors.ChatBskyConvoLeaveConvoAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChatBskyConvoLeaveConvoRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ChatBskyConvoLeaveConvoResponse$inboundSchema),
    M.jsonErr(400, errors.ChatBskyConvoLeaveConvoBadRequestError$inboundSchema),
    M.jsonErr(
      401,
      errors.ChatBskyConvoLeaveConvoAuthMissingError$inboundSchema,
    ),
