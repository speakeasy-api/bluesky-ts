...
export function conversationsLeave(
  ...
  Result<
    ...
    | errors.BadRequestChatBskyConvoLeaveConvoResponseBodyError
    | errors.UnauthorizedChatBskyConvoLeaveConvoResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChatBskyConvoLeaveConvoBody$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.BadRequestChatBskyConvoLeaveConvoResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.UnauthorizedChatBskyConvoLeaveConvoResponseBodyError$inboundSchema,
    ),
