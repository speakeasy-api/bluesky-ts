...
export function adminsDeleteAccount(
  ...
  Result<
    void,
    | errors.ComAtprotoAdminDeleteAccountBadRequestError
    | errors.ComAtprotoAdminDeleteAccountAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminDeleteAccountRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ComAtprotoAdminDeleteAccountBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminDeleteAccountAuthMissingError$inboundSchema,
    ),
