 ...
 */
export function adminsDeleteAccount(
  client: BlueskyCore,
  ...
  Result<
    void,
    | errors.BadRequestComAtprotoAdminDeleteAccountResponseBodyError
    | errors.UnauthorizedComAtprotoAdminDeleteAccountResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComAtprotoAdminDeleteAccountBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/xrpc/com.atproto.admin.deleteAccount")();
