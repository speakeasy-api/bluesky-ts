 ...
 */
export async function adminsDeleteAccount(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ComAtprotoAdminDeleteAccountAdminsResponseBody
    | errors.NotFound
    | errors.Unauthorized
    | errors.Timeout
    | errors.RateLimited
...
> {
  ...
  >(
    ...
    M.jsonErr(
      401,
      errors.ComAtprotoAdminDeleteAccountAdminsResponseBody$inboundSchema,
    ),
