...
export function chatConvoSendMessageBatch(
  ...
  Result<
    ...
    | errors.BadRequestChatBskyConvoSendMessageBatchResponseBodyError
    | errors.UnauthorizedChatBskyConvoSendMessageBatchResponseBodyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChatBskyConvoSendMessageBatchBody$outboundSchema.parse(value),
