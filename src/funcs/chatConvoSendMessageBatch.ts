 ...
 */
export function chatConvoSendMessageBatch(
  client: BlueskyCore,
  ...
  Result<
    ...
    | errors.ChatBskyConvoSendMessageBatchBadRequestError
    | errors.ChatBskyConvoSendMessageBatchAuthMissingError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChatBskyConvoSendMessageBatchRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ChatBskyConvoSendMessageBatchResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.ChatBskyConvoSendMessageBatchBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ChatBskyConvoSendMessageBatchAuthMissingError$inboundSchema,
    ),
