...
export function conversationsGetLog(
  ...
  PageIterator<
    Result<
      ...
      | errors.ChatBskyConvoGetLogBadRequestError
      | errors.ChatBskyConvoGetLogAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.ChatBskyConvoGetLogBadRequestError$inboundSchema),
    M.jsonErr(401, errors.ChatBskyConvoGetLogAuthMissingError$inboundSchema),
