...
export function feedsGet(
  ...
  Result<
    operations.AppBskyFeedGetPostsResponse,
    | errors.AppBskyFeedGetPostsBadRequestError
    | errors.AppBskyFeedGetPostsAuthMissingError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppBskyFeedGetPostsResponse$inboundSchema),
    M.jsonErr(400, errors.AppBskyFeedGetPostsBadRequestError$inboundSchema),
    M.jsonErr(401, errors.AppBskyFeedGetPostsAuthMissingError$inboundSchema),
