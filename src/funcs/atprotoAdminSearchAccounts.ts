...
export function atprotoAdminSearchAccounts(
  ...
  PageIterator<
    Result<
      ...
      | errors.ComAtprotoAdminSearchAccountsBadRequestError
      | errors.ComAtprotoAdminSearchAccountsAuthMissingError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ComAtprotoAdminSearchAccountsResponse$inboundSchema,
      { key: "Result" },
    ),
    M.jsonErr(
      400,
      errors.ComAtprotoAdminSearchAccountsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.ComAtprotoAdminSearchAccountsAuthMissingError$inboundSchema,
    ),
