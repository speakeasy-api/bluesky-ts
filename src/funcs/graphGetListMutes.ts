 ...
 */
export function graphGetListMutes(
  client: BlueskyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.BadRequestAppBskyGraphGetListMutesResponseBodyError
      | errors.UnauthorizedAppBskyGraphGetListMutesResponseBodyError
...
> {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AppBskyGraphGetListMutesResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
      400,
      errors.BadRequestAppBskyGraphGetListMutesResponseBodyError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
