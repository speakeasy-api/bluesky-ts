...
export function graphGetListMutes(
  ...
  PageIterator<
    Result<
      ...
      | errors.AppBskyGraphGetListMutesBadRequestError
      | errors.AppBskyGraphGetListMutesAuthMissingError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.AppBskyGraphGetListMutesBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors.AppBskyGraphGetListMutesAuthMissingError$inboundSchema,
    ),
