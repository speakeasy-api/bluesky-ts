...
const args = {
  request: operations.ComAtprotoAdminSendEmailRequestBody$inboundSchema,
};

export const tool$adminSendEmail: ToolDefinition<typeof args> = {
  name: "admin_send-email",
  description:
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await adminSendEmail(
      client,
      args.request,
