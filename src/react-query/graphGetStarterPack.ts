...
export function useGraphGetStarterPack(
  ...
  options?: QueryHookOptions<operations.AppBskyGraphGetStarterPackResponseBody>,
): UseQueryResult<operations.AppBskyGraphGetStarterPackResponseBody, Error> {
...
export function setGraphGetStarterPackData(
  ...
  data: operations.AppBskyGraphGetStarterPackResponseBody,
): operations.AppBskyGraphGetStarterPackResponseBody | undefined {
  const key = queryKeyGraphGetStarterPack(...queryKeyBase);

  return client.setQueryData<operations.AppBskyGraphGetStarterPackResponseBody>(
    key,
    data,
  );
}
...
export function buildGraphGetStarterPackQuery(
  ...
  return {
    ...
    queryFn: async function graphGetStarterPackQuery(
      ctx,
    ): Promise<operations.AppBskyGraphGetStarterPackResponseBody> {
