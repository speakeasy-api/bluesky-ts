...
export function setChatModerationGetActorMetadataData(
  ...
  data: operations.ChatBskyModerationGetActorMetadataResponseBody,
): operations.ChatBskyModerationGetActorMetadataResponseBody | undefined {
...
export function invalidateChatModerationGetActorMetadata(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["bluesky", "moderation", "getActorMetadata", ...queryKeyBase],
  });
}
...
export function invalidateAllChatModerationGetActorMetadata(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["bluesky", "moderation", "getActorMetadata"],
  });
}
...
export function buildChatModerationGetActorMetadataQuery(
  ...
  return {
    ...
    queryFn: async function chatModerationGetActorMetadataQuery(
      ctx,
    ): Promise<operations.ChatBskyModerationGetActorMetadataResponseBody> {
...
export function queryKeyChatModerationGetActorMetadata(
  ...
  return ["bluesky", "moderation", "getActorMetadata", parameters];
}
