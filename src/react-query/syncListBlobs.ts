...
export function invalidateSyncListBlobs(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["@speakeasy-sdks/bluesky", "sync", "listBlobs", ...queryKeyBase],
  });
}
...
export function invalidateAllSyncListBlobs(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["@speakeasy-sdks/bluesky", "sync", "listBlobs"],
  });
}
...
export function queryKeySyncListBlobs(
  ...
  return ["@speakeasy-sdks/bluesky", "sync", "listBlobs", parameters];
}
