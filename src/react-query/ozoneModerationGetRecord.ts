...
export function useOzoneModerationGetRecord(
  ...
  options?: QueryHookOptions<
    components.ToolsOzoneModerationDefsRecordViewDetail
  >,
): UseQueryResult<components.ToolsOzoneModerationDefsRecordViewDetail, Error> {
...
export function setOzoneModerationGetRecordData(
  ...
  data: components.ToolsOzoneModerationDefsRecordViewDetail,
): components.ToolsOzoneModerationDefsRecordViewDetail | undefined {
...
export function invalidateOzoneModerationGetRecord(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["bluesky", "moderation", "getRecord", ...queryKeyBase],
  });
}
...
export function invalidateAllOzoneModerationGetRecord(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["bluesky", "moderation", "getRecord"],
  });
}
...
export function buildOzoneModerationGetRecordQuery(
  ...
  return {
    ...
    queryFn: async function ozoneModerationGetRecordQuery(
      ctx,
    ): Promise<components.ToolsOzoneModerationDefsRecordViewDetail> {
...
export function queryKeyOzoneModerationGetRecord(
  ...
  return ["bluesky", "moderation", "getRecord", parameters];
}
