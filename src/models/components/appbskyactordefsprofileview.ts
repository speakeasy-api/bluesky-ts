 ...
 */
export namespace AppBskyActorDefsProfileView$ {
  /** @deprecated use `AppBskyActorDefsProfileView$inboundSchema` instead. */
  export const inboundSchema = AppBskyActorDefsProfileView$inboundSchema;
  /** @deprecated use `AppBskyActorDefsProfileView$outboundSchema` instead. */
  export const outboundSchema = AppBskyActorDefsProfileView$outboundSchema;
  /** @deprecated use `AppBskyActorDefsProfileView$Outbound` instead. */
  export type Outbound = AppBskyActorDefsProfileView$Outbound;
}
