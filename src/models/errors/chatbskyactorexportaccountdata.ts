 ...
 * Unauthorized
 */
export type ChatBskyActorExportAccountDataChatBskyActorResponseBodyData = {
  error: "AuthMissing";
  message: string;
};
 ...
 * Unauthorized
 */
export class ChatBskyActorExportAccountDataChatBskyActorResponseBody
  extends Error
{
  error: "AuthMissing";

  /** The original data that was passed to this error instance. */
  data$: ChatBskyActorExportAccountDataChatBskyActorResponseBodyData;

  constructor(
    err: ChatBskyActorExportAccountDataChatBskyActorResponseBodyData,
  ) {
    ...
    this.name = "ChatBskyActorExportAccountDataChatBskyActorResponseBody";
  }
}
...
/** @internal */
export const ChatBskyActorExportAccountDataChatBskyActorResponseBody$inboundSchema:
  z.ZodType<
  ...
  > = z.object({
    ...
    .transform((v) => {
      return new ChatBskyActorExportAccountDataChatBskyActorResponseBody(v);
    });

/** @internal */
export type ChatBskyActorExportAccountDataChatBskyActorResponseBody$Outbound = {
  error: "AuthMissing";
  message: string;
};

/** @internal */
export const ChatBskyActorExportAccountDataChatBskyActorResponseBody$outboundSchema:
  z.ZodType<
    ChatBskyActorExportAccountDataChatBskyActorResponseBody$Outbound,
    z.ZodTypeDef,
    ChatBskyActorExportAccountDataChatBskyActorResponseBody
  > = z.instanceof(ChatBskyActorExportAccountDataChatBskyActorResponseBody)
    .transform(v => v.data$)
    .pipe(z.object({
 ...
 */
export namespace ChatBskyActorExportAccountDataChatBskyActorResponseBody$ {
  /** @deprecated use `ChatBskyActorExportAccountDataChatBskyActorResponseBody$inboundSchema` instead. */
  export const inboundSchema =
    ChatBskyActorExportAccountDataChatBskyActorResponseBody$inboundSchema;
  /** @deprecated use `ChatBskyActorExportAccountDataChatBskyActorResponseBody$outboundSchema` instead. */
  export const outboundSchema =
    ChatBskyActorExportAccountDataChatBskyActorResponseBody$outboundSchema;
  /** @deprecated use `ChatBskyActorExportAccountDataChatBskyActorResponseBody$Outbound` instead. */
