 ...
 * Unauthorized
 */
export type AppBskyVideoUploadVideoAppBskyVideoResponseBodyData = {
  error: "AuthMissing";
  message: string;
};
 ...
 * Unauthorized
 */
export class AppBskyVideoUploadVideoAppBskyVideoResponseBody extends Error {
  error: "AuthMissing";

  /** The original data that was passed to this error instance. */
  data$: AppBskyVideoUploadVideoAppBskyVideoResponseBodyData;

  constructor(err: AppBskyVideoUploadVideoAppBskyVideoResponseBodyData) {
    ...
    this.name = "AppBskyVideoUploadVideoAppBskyVideoResponseBody";
  }
}
...
/** @internal */
export const AppBskyVideoUploadVideoAppBskyVideoResponseBody$inboundSchema:
  z.ZodType<
  ...
  > = z.object({
    ...
    .transform((v) => {
      return new AppBskyVideoUploadVideoAppBskyVideoResponseBody(v);
    });

/** @internal */
export type AppBskyVideoUploadVideoAppBskyVideoResponseBody$Outbound = {
  error: "AuthMissing";
  message: string;
};

/** @internal */
export const AppBskyVideoUploadVideoAppBskyVideoResponseBody$outboundSchema:
  z.ZodType<
    AppBskyVideoUploadVideoAppBskyVideoResponseBody$Outbound,
    z.ZodTypeDef,
    AppBskyVideoUploadVideoAppBskyVideoResponseBody
  > = z.instanceof(AppBskyVideoUploadVideoAppBskyVideoResponseBody)
    .transform(v => v.data$)
    .pipe(z.object({
 ...
 */
export namespace AppBskyVideoUploadVideoAppBskyVideoResponseBody$ {
  /** @deprecated use `AppBskyVideoUploadVideoAppBskyVideoResponseBody$inboundSchema` instead. */
  export const inboundSchema =
    AppBskyVideoUploadVideoAppBskyVideoResponseBody$inboundSchema;
  /** @deprecated use `AppBskyVideoUploadVideoAppBskyVideoResponseBody$outboundSchema` instead. */
  export const outboundSchema =
    AppBskyVideoUploadVideoAppBskyVideoResponseBody$outboundSchema;
  /** @deprecated use `AppBskyVideoUploadVideoAppBskyVideoResponseBody$Outbound` instead. */
